 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fl=()=>Ll().__FIREBASE_DEFAULTS__,Bl=()=>{if(typeof process>"u"||typeof qo>"u")return;const n=qo.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Ul=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&Ol(n[1]);return t&&JSON.parse(t)},ci=()=>{try{return xl()||Fl()||Bl()||Ul()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},ql=n=>{var t,e;return(e=(t=ci())==null?void 0:t.emulatorHosts)==null?void 0:e[n]},jl=n=>{const t=ql(n);if(!t)return;const e=t.lastIndexOf(":");if(e<=0||e+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const r=parseInt(t.substring(e+1),10);return t[0]==="["?[t.substring(1,e-1),r]:[t.substring(0,e),r]},rc=()=>{var n;return(n=ci())==null?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ui(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function $l(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hl(n,t){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const e={alg:"none",type:"JWT"},r=t||"demo-project",s=n.iat||0,o=n.sub||n.user_id;if(!o)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a={iss:`https://securetoken.google.com/${r}`,aud:r,iat:s,exp:s+3600,auth_time:s,sub:o,user_id:o,firebase:{sign_in_provider:"custom",identities:{}},...n};return[Pr(JSON.stringify(e)),Pr(JSON.stringify(a)),""].join(".")}const kn={};function Gl(){const n={prod:[],emulator:[]};for(const t of Object.keys(kn))kn[t]?n.emulator.push(t):n.prod.push(t);return n}function Kl(n){let t=document.getElementById(n),e=!1;return t||(t=document.createElement("div"),t.setAttribute("id",n),e=!0),{created:e,element:t}}let jo=!1;function Wl(n,t){if(typeof window>"u"||typeof document>"u"||!ui(window.location.host)||kn[n]===t||kn[n]||jo)return;kn[n]=t;function e(A){return`__firebase__banner__${A}`}const r="__firebase__banner",o=Gl().prod.length>0;function a(){const A=document.getElementById(r);A&&A.remove()}function l(A){A.style.display="flex",A.style.background="#7faaf0",A.style.position="fixed",A.style.bottom="5px",A.style.left="5px",A.style.padding=".5em",A.style.borderRadius="5px",A.style.alignItems="center"}function h(A,R){A.setAttribute("width","24"),A.setAttribute("id",R),A.setAttribute("height","24"),A.setAttribute("viewBox","0 0 24 24"),A.setAttribute("fill","none"),A.style.marginLeft="-6px"}function d(){const A=document.createElement("span");return A.style.cursor="pointer",A.style.marginLeft="16px",A.style.fontSize="24px",A.innerHTML=" &times;",A.onclick=()=>{jo=!0,a()},A}function p(A,R){A.setAttribute("id",R),A.innerText="Learn more",A.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",A.setAttribute("target","__blank"),A.style.paddingLeft="5px",A.style.textDecoration="underline"}function y(){const A=Kl(r),R=e("text"),N=document.getElementById(R)||document.createElement("span"),k=e("learnmore"),V=document.getElementById(k)||document.createElement("a"),B=e("preprendIcon"),U=document.getElementById(B)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(A.created){const H=A.element;l(H),p(V,k);const et=d();h(U,B),H.append(U,N,V,et),document.body.appendChild(H)}o?(N.innerText="Preview backend disconnected.",U.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th="FirebaseError";class an extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=th,Object.setPrototypeOf(this,an.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,sc.prototype.create)}}class sc{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?eh(o,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new an(s,l,r)}}function eh(n,t){return n.replace(nh,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const nh=/\{\$([^}]+)}/g;function Vr(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(zo(o)&&zo(a)){if(!Vr(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function zo(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Z;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Z||(Z={}));const ah={debug:Z.DEBUG,verbose:Z.VERBOSE,info:Z.INFO,warn:Z.WARN,error:Z.ERROR,silent:Z.SILENT},ch=Z.INFO,uh={[Z.DEBUG]:"log",[Z.VERBOSE]:"log",[Z.INFO]:"info",[Z.WARN]:"warn",[Z.ERROR]:"error"},lh=(n,t,...e)=>{if(t<n.logLevel)return;const r=new Date().toISOString(),s=uh[t];if(s)console[s](`[${r}]  ${n.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class ic{constructor(t){this.name=t,this._logLevel=ch,this._logHandler=lh,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in Z))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?ah[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,Z.DEBUG,...t),this._logHandler(this,Z.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,Z.VERBOSE,...t),this._logHandler(this,Z.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,Z.INFO,...t),this._logHandler(this,Z.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,Z.WARN,...t),this._logHandler(this,Z.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,Z.ERROR,...t),this._logHandler(this,Z.ERROR,...t)}}const hh=(n,t)=>t.some(e=>n instanceof e);let $o,Ho;function dh(){return $o||($o=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function fh(){return Ho||(Ho=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const oc=new WeakMap,Bs=new WeakMap,ac=new WeakMap,Ps=new WeakMap,li=new WeakMap;function mh(n){const t=new Promise((e,r)=>{const s=()=>{n.removeEventListener("success",o),n.removeEventListener("error",a)},o=()=>{e(le(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",o),n.addEventListener("error",a)});return t.then(e=>{e instanceof IDBCursor&&oc.set(e,n)}).catch(()=>{}),li.set(t,n),t}function ph(n){if(Bs.has(n))return;const t=new Promise((e,r)=>{const s=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",a),n.removeEventListener("abort",a)},o=()=>{e(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",o),n.addEventListener("error",a),n.addEventListener("abort",a)});Bs.set(n,t)}let Us={get(n,t,e){if(n instanceof IDBTransaction){if(t==="done")return Bs.get(n);if(t==="objectStoreNames")return n.objectStoreNames||ac.get(n);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return le(n[t])},set(n,t,e){return n[t]=e,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function gh(n){Us=n(Us)}function _h(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const r=n.call(Vs(this),t,...e);return ac.set(r,t.sort?t.sort():[t]),le(r)}:fh().includes(n)?function(...t){return n.apply(Vs(this),t),le(oc.get(this))}:function(...t){return le(n.apply(Vs(this),t))}}function yh(n){return typeof n=="function"?_h(n):(n instanceof IDBTransaction&&ph(n),hh(n,dh())?new Proxy(n,Us):n)}function le(n){if(n instanceof IDBRequest)return mh(n);if(Ps.has(n))return Ps.get(n);const t=yh(n);return t!==n&&(Ps.set(n,t),li.set(t,n)),t}const Vs=n=>li.get(n);function Eh(n,t,{blocked:e,upgrade:r,blocking:s,terminated:o}={}){const a=indexedDB.open(n,t),l=le(a);return r&&a.addEventListener("upgradeneeded",h=>{r(le(a.result),h.oldVersion,h.newVersion,le(a.transaction),h)}),e&&a.addEventListener("blocked",h=>e(h.oldVersion,h.newVersion,h)),l.then(h=>{o&&h.addEventListener("close",()=>o()),s&&h.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const vh=["get","getKey","getAll","getAllKeys","count"],Th=["put","add","delete","clear"],Ds=new Map;function Go(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(Ds.get(t))return Ds.get(t);const e=t.replace(/FromIndex$/,""),r=t!==e,s=Th.includes(e);if(!(e in(r?IDBIndex:IDBObjectStore).prototype)||!(s||vh.includes(e)))return;const o=async function(a,...l){const h=this.transaction(a,s?"readwrite":"readonly");let d=h.store;return r&&(d=d.index(l.shift())),(await Promise.all([d[e](...l),s&&h.done]))[0]};return Ds.set(t,o),o}gh(n=>({...n,get:(t,e,r)=>Go(t,e)||n.get(t,e,r),has:(t,e)=>!!Go(t,e)||n.has(t,e)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wh{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Ih(e)){const r=e.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(e=>e).join(" ")}}function Ih(n){const t=n.getComponent();return(t==null?void 0:t.type)==="VERSION"}const qs="@firebase/app",Ko="0.14.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rd=Xh;function cc(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r={name:js,automaticDataCollectionEnabled:!0,...t},s=r.name;if(typeof s!="string"||!s)throw he.create("bad-app-name",{appName:String(s)});if(e||(e=rc()),!e)throw he.create("no-options");const o=Dr.get(s);if(o){if(Vr(e,o.options)&&Vr(r,o.config))return o;throw he.create("duplicate-app",{appName:s})}const a=new oh(s);for(const h of zs.values())a.addComponent(h);const l=new nd(e,r,a);return Dr.set(s,l),l}function sd(n=js){const t=Dr.get(n);if(!t&&n===js&&rc())return cc();if(!t)throw he.create("no-app",{appName:n});return t}function Xe(n,t,e){let r=Yh[n]??n;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${t}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Zt.warn(a.join(" "));return}xr(new Un(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const id="firebase-heartbeat-database",od=1,qn="firebase-heartbeat-store";let xs=null;function uc(){return xs||(xs=Eh(id,od,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(qn)}catch(e){console.warn(e)}}}}).catch(n=>{throw he.create("idb-open",{originalErrorMessage:n.message})})),xs}async function ad(n){try{const e=(await uc()).transaction(qn),r=await e.objectStore(qn).get(lc(n));return await e.done,r}catch(t){if(t instanceof an)Zt.warn(t.message);else{const e=he.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Zt.warn(e.message)}}}async function Qo(n,t){try{const r=(await uc()).transaction(qn,"readwrite");await r.objectStore(qn).put(t,lc(n)),await r.done}catch(e){if(e instanceof an)Zt.warn(e.message);else{const r=he.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Zt.warn(r.message)}}}function lc(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd=1024,ud=30;class ld{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new dd(e),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,e;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Xo();if(((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:s}),this._heartbeatsCache.heartbeats.length>ud){const a=fd(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){Zt.warn(r)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Xo(),{heartbeatsToSend:r,unsentEntries:s}=hd(this._heartbeatsCache.heartbeats),o=Pr(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return Zt.warn(e),""}}}function Xo(){return new Date().toISOString().substring(0,10)}function hd(n,t=cd){const e=[];let r=n.slice();for(const s of n){const o=e.find(a=>a.agent===s.agent);if(o){if(o.dates.push(s.date),Yo(e)>t){o.dates.pop();break}}else if(e.push({agent:s.agent,dates:[s.date]}),Yo(e)>t){e.pop();break}r=r.slice(1)}return{heartbeatsToSend:e,unsentEntries:r}}class dd{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Jl()?Zl().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await ad(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const r=await this.read();return Qo(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const r=await this.read();return Qo(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...t.heartbeats]})}else return}}function Yo(n){return Pr(JSON.stringify({version:2,heartbeats:n})).length}function fd(n){if(n.length===0)return-1;let t=0,e=n[0].date;for(let r=1;r<n.length;r++)n[r].date<e&&(e=n[r].date,t=r);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function md(n){xr(new Un("platform-logger",t=>new wh(t),"PRIVATE")),xr(new Un("heartbeat",t=>new ld(t),"PRIVATE")),Xe(qs,Ko,n),Xe(qs,Ko,"esm2020"),Xe("fire-js","")}md("");var pd="firebase",gd="12.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Xe(pd,gd,"app");var Jo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var de,hc;(function(){var n;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(v,m){function _(){}_.prototype=m.prototype,v.F=m.prototype,v.prototype=new _,v.prototype.constructor=v,v.D=function(T,E,w){for(var g=Array(arguments.length-2),Et=2;Et<arguments.length;Et++)g[Et-2]=arguments[Et];return m.prototype[E].apply(T,g)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}t(r,e),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(v,m,_){_||(_=0);const T=Array(16);if(typeof m=="string")for(var E=0;E<16;++E)T[E]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(E=0;E<16;++E)T[E]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=v.g[0],_=v.g[1],E=v.g[2];let w=v.g[3],g;g=m+(w^_&(E^w))+T[0]+3614090360&4294967295,m=_+(g<<7&4294967295|g>>>25),g=w+(E^m&(_^E))+T[1]+3905402710&4294967295,w=m+(g<<12&4294967295|g>>>20),g=E+(_^w&(m^_))+T[2]+606105819&4294967295,E=w+(g<<17&4294967295|g>>>15),g=_+(m^E&(w^m))+T[3]+3250441966&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(w^_&(E^w))+T[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=w+(E^m&(_^E))+T[5]+1200080426&4294967295,w=m+(g<<12&4294967295|g>>>20),g=E+(_^w&(m^_))+T[6]+2821735955&4294967295,E=w+(g<<17&4294967295|g>>>15),g=_+(m^E&(w^m))+T[7]+4249261313&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(w^_&(E^w))+T[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=w+(E^m&(_^E))+T[9]+2336552879&4294967295,w=m+(g<<12&4294967295|g>>>20),g=E+(_^w&(m^_))+T[10]+4294925233&4294967295,E=w+(g<<17&4294967295|g>>>15),g=_+(m^E&(w^m))+T[11]+2304563134&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(w^_&(E^w))+T[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=w+(E^m&(_^E))+T[13]+4254626195&4294967295,w=m+(g<<12&4294967295|g>>>20),g=E+(_^w&(m^_))+T[14]+2792965006&4294967295,E=w+(g<<17&4294967295|g>>>15),g=_+(m^E&(w^m))+T[15]+1236535329&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(E^w&(_^E))+T[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=w+(_^E&(m^_))+T[6]+3225465664&4294967295,w=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(w^m))+T[11]+643717713&4294967295,E=w+(g<<14&4294967295|g>>>18),g=_+(w^m&(E^w))+T[0]+3921069994&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^w&(_^E))+T[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=w+(_^E&(m^_))+T[10]+38016083&4294967295,w=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(w^m))+T[15]+3634488961&4294967295,E=w+(g<<14&4294967295|g>>>18),g=_+(w^m&(E^w))+T[4]+3889429448&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^w&(_^E))+T[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=w+(_^E&(m^_))+T[14]+3275163606&4294967295,w=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(w^m))+T[3]+4107603335&4294967295,E=w+(g<<14&4294967295|g>>>18),g=_+(w^m&(E^w))+T[8]+1163531501&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^w&(_^E))+T[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=w+(_^E&(m^_))+T[2]+4243563512&4294967295,w=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(w^m))+T[7]+1735328473&4294967295,E=w+(g<<14&4294967295|g>>>18),g=_+(w^m&(E^w))+T[12]+2368359562&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(_^E^w)+T[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=w+(m^_^E)+T[8]+2272392833&4294967295,w=m+(g<<11&4294967295|g>>>21),g=E+(w^m^_)+T[11]+1839030562&4294967295,E=w+(g<<16&4294967295|g>>>16),g=_+(E^w^m)+T[14]+4259657740&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^w)+T[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=w+(m^_^E)+T[4]+1272893353&4294967295,w=m+(g<<11&4294967295|g>>>21),g=E+(w^m^_)+T[7]+4139469664&4294967295,E=w+(g<<16&4294967295|g>>>16),g=_+(E^w^m)+T[10]+3200236656&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^w)+T[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=w+(m^_^E)+T[0]+3936430074&4294967295,w=m+(g<<11&4294967295|g>>>21),g=E+(w^m^_)+T[3]+3572445317&4294967295,E=w+(g<<16&4294967295|g>>>16),g=_+(E^w^m)+T[6]+76029189&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^w)+T[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=w+(m^_^E)+T[12]+3873151461&4294967295,w=m+(g<<11&4294967295|g>>>21),g=E+(w^m^_)+T[15]+530742520&4294967295,E=w+(g<<16&4294967295|g>>>16),g=_+(E^w^m)+T[2]+3299628645&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(E^(_|~w))+T[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=w+(_^(m|~E))+T[7]+1126891415&4294967295,w=m+(g<<10&4294967295|g>>>22),g=E+(m^(w|~_))+T[14]+2878612391&4294967295,E=w+(g<<15&4294967295|g>>>17),g=_+(w^(E|~m))+T[5]+4237533241&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~w))+T[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=w+(_^(m|~E))+T[3]+2399980690&4294967295,w=m+(g<<10&4294967295|g>>>22),g=E+(m^(w|~_))+T[10]+4293915773&4294967295,E=w+(g<<15&4294967295|g>>>17),g=_+(w^(E|~m))+T[1]+2240044497&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~w))+T[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=w+(_^(m|~E))+T[15]+4264355552&4294967295,w=m+(g<<10&4294967295|g>>>22),g=E+(m^(w|~_))+T[6]+2734768916&4294967295,E=w+(g<<15&4294967295|g>>>17),g=_+(w^(E|~m))+T[13]+1309151649&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~w))+T[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=w+(_^(m|~E))+T[11]+3174756917&4294967295,w=m+(g<<10&4294967295|g>>>22),g=E+(m^(w|~_))+T[2]+718787259&4294967295,E=w+(g<<15&4294967295|g>>>17),g=_+(w^(E|~m))+T[9]+3951481745&4294967295,v.g[0]=v.g[0]+m&4294967295,v.g[1]=v.g[1]+(E+(g<<21&4294967295|g>>>11))&4294967295,v.g[2]=v.g[2]+E&4294967295,v.g[3]=v.g[3]+w&4294967295}r.prototype.v=function(v,m){m===void 0&&(m=v.length);const _=m-this.blockSize,T=this.C;let E=this.h,w=0;for(;w<m;){if(E==0)for(;w<=_;)s(this,v,w),w+=this.blockSize;if(typeof v=="string"){for(;w<m;)if(T[E++]=v.charCodeAt(w++),E==this.blockSize){s(this,T),E=0;break}}else for(;w<m;)if(T[E++]=v[w++],E==this.blockSize){s(this,T),E=0;break}}this.h=E,this.o+=m},r.prototype.A=function(){var v=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);v[0]=128;for(var m=1;m<v.length-8;++m)v[m]=0;m=this.o*8;for(var _=v.length-8;_<v.length;++_)v[_]=m&255,m/=256;for(this.v(v),v=Array(16),m=0,_=0;_<4;++_)for(let T=0;T<32;T+=8)v[m++]=this.g[_]>>>T&255;return v};function o(v,m){var _=l;return Object.prototype.hasOwnProperty.call(_,v)?_[v]:_[v]=m(v)}function a(v,m){this.h=m;const _=[];let T=!0;for(let E=v.length-1;E>=0;E--){const w=v[E]|0;T&&w==m||(_[E]=w,T=!1)}this.g=_}var l={};function h(v){return-128<=v&&v<128?o(v,function(m){return new a([m|0],m<0?-1:0)}):new a([v|0],v<0?-1:0)}function d(v){if(isNaN(v)||!isFinite(v))return y;if(v<0)return V(d(-v));const m=[];let _=1;for(let T=0;v>=_;T++)m[T]=v/_|0,_*=4294967296;return new a(m,0)}function p(v,m){if(v.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(v.charAt(0)=="-")return V(p(v.substring(1),m));if(v.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(m,8));let T=y;for(let w=0;w<v.length;w+=8){var E=Math.min(8,v.length-w);const g=parseInt(v.substring(w,w+E),m);E<8?(E=d(Math.pow(m,E)),T=T.j(E).add(d(g))):(T=T.j(_),T=T.add(d(g)))}return T}var y=h(0),A=h(1),R=h(16777216);n=a.prototype,n.m=function(){if(k(this))return-V(this).m();let v=0,m=1;for(let _=0;_<this.g.length;_++){const T=this.i(_);v+=(T>=0?T:4294967296+T)*m,m*=4294967296}return v},n.toString=function(v){if(v=v||10,v<2||36<v)throw Error("radix out of range: "+v);if(N(this))return"0";if(k(this))return"-"+V(this).toString(v);const m=d(Math.pow(v,6));var _=this;let T="";for(;;){const E=et(_,m).g;_=B(_,E.j(m));let w=((_.g.length>0?_.g[0]:_.h)>>>0).toString(v);if(_=E,N(_))return w+T;for(;w.length<6;)w="0"+w;T=w+T}},n.i=function(v){return v<0?0:v<this.g.length?this.g[v]:this.h};function N(v){if(v.h!=0)return!1;for(let m=0;m<v.g.length;m++)if(v.g[m]!=0)return!1;return!0}function k(v){return v.h==-1}n.l=function(v){return v=B(this,v),k(v)?-1:N(v)?0:1};function V(v){const m=v.g.length,_=[];for(let T=0;T<m;T++)_[T]=~v.g[T];return new a(_,~v.h).add(A)}n.abs=function(){return k(this)?V(this):this},n.add=function(v){const m=Math.max(this.g.length,v.g.length),_=[];let T=0;for(let E=0;E<=m;E++){let w=T+(this.i(E)&65535)+(v.i(E)&65535),g=(w>>>16)+(this.i(E)>>>16)+(v.i(E)>>>16);T=g>>>16,w&=65535,g&=65535,_[E]=g<<16|w}return new a(_,_[_.length-1]&-2147483648?-1:0)};function B(v,m){return v.add(V(m))}n.j=function(v){if(N(this)||N(v))return y;if(k(this))return k(v)?V(this).j(V(v)):V(V(this).j(v));if(k(v))return V(this.j(V(v)));if(this.l(R)<0&&v.l(R)<0)return d(this.m()*v.m());const m=this.g.length+v.g.length,_=[];for(var T=0;T<2*m;T++)_[T]=0;for(T=0;T<this.g.length;T++)for(let E=0;E<v.g.length;E++){const w=this.i(T)>>>16,g=this.i(T)&65535,Et=v.i(E)>>>16,Lt=v.i(E)&65535;_[2*T+2*E]+=g*Lt,U(_,2*T+2*E),_[2*T+2*E+1]+=w*Lt,U(_,2*T+2*E+1),_[2*T+2*E+1]+=g*Et,U(_,2*T+2*E+1),_[2*T+2*E+2]+=w*Et,U(_,2*T+2*E+2)}for(v=0;v<m;v++)_[v]=_[2*v+1]<<16|_[2*v];for(v=m;v<2*m;v++)_[v]=0;return new a(_,0)};function U(v,m){for(;(v[m]&65535)!=v[m];)v[m+1]+=v[m]>>>16,v[m]&=65535,m++}function H(v,m){this.g=v,this.h=m}function et(v,m){if(N(m))throw Error("division by zero");if(N(v))return new H(y,y);if(k(v))return m=et(V(v),m),new H(V(m.g),V(m.h));if(k(m))return m=et(v,V(m)),new H(V(m.g),m.h);if(v.g.length>30){if(k(v)||k(m))throw Error("slowDivide_ only works with positive integers.");for(var _=A,T=m;T.l(v)<=0;)_=ft(_),T=ft(T);var E=at(_,1),w=at(T,1);for(T=at(T,2),_=at(_,2);!N(T);){var g=w.add(T);g.l(v)<=0&&(E=E.add(_),w=g),T=at(T,1),_=at(_,1)}return m=B(v,E.j(m)),new H(E,m)}for(E=y;v.l(m)>=0;){for(_=Math.max(1,Math.floor(v.m()/m.m())),T=Math.ceil(Math.log(_)/Math.LN2),T=T<=48?1:Math.pow(2,T-48),w=d(_),g=w.j(m);k(g)||g.l(v)>0;)_-=T,w=d(_),g=w.j(m);N(w)&&(w=A),E=E.add(w),v=B(v,g)}return new H(E,v)}n.B=function(v){return et(this,v).h},n.and=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let T=0;T<m;T++)_[T]=this.i(T)&v.i(T);return new a(_,this.h&v.h)},n.or=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let T=0;T<m;T++)_[T]=this.i(T)|v.i(T);return new a(_,this.h|v.h)},n.xor=function(v){const m=Math.max(this.g.length,v.g.length),_=[];for(let T=0;T<m;T++)_[T]=this.i(T)^v.i(T);return new a(_,this.h^v.h)};function ft(v){const m=v.g.length+1,_=[];for(let T=0;T<m;T++)_[T]=v.i(T)<<1|v.i(T-1)>>>31;return new a(_,v.h)}function at(v,m){const _=m>>5;m%=32;const T=v.g.length-_,E=[];for(let w=0;w<T;w++)E[w]=m>0?v.i(w+_)>>>m|v.i(w+_+1)<<32-m:v.i(w+_);return new a(E,v.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,hc=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,de=a}).apply(typeof Jo<"u"?Jo:typeof self<"u"?self:typeof window<"u"?window:{});var yr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var dc,Vn,fc,Ir,$s,mc,pc,gc;(function(){var n,t=Object.defineProperty;function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof yr=="object"&&yr];for(var c=0;c<i.length;++c){var u=i[c];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var r=e(this);function s(i,c){if(c)t:{var u=r;i=i.split(".");for(var f=0;f<i.length-1;f++){var I=i[f];if(!(I in u))break t;u=u[I]}i=i[i.length-1],f=u[i],c=c(f),c!=f&&c!=null&&t(u,i,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(i){return i||function(c){var u=[],f;for(f in c)Object.prototype.hasOwnProperty.call(c,f)&&u.push([f,c[f]]);return u}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function l(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function h(i,c,u){return i.call.apply(i.bind,arguments)}function d(i,c,u){return d=h,d.apply(null,arguments)}function p(i,c){var u=Array.prototype.slice.call(arguments,1);return function(){var f=u.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function y(i,c){function u(){}u.prototype=c.prototype,i.Z=c.prototype,i.prototype=new u,i.prototype.constructor=i,i.Ob=function(f,I,b){for(var P=Array(arguments.length-2),K=2;K<arguments.length;K++)P[K-2]=arguments[K];return c.prototype[I].apply(f,P)}}var A=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function R(i){const c=i.length;if(c>0){const u=Array(c);for(let f=0;f<c;f++)u[f]=i[f];return u}return[]}function N(i,c){for(let f=1;f<arguments.length;f++){const I=arguments[f];var u=typeof I;if(u=u!="object"?u:I?Array.isArray(I)?"array":u:"null",u=="array"||u=="object"&&typeof I.length=="number"){u=i.length||0;const b=I.length||0;i.length=u+b;for(let P=0;P<b;P++)i[u+P]=I[P]}else i.push(I)}}class k{constructor(c,u){this.i=c,this.j=u,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function V(i){a.setTimeout(()=>{throw i},0)}function B(){var i=v;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class U{constructor(){this.h=this.g=null}add(c,u){const f=H.get();f.set(c,u),this.h?this.h.next=f:this.g=f,this.h=f}}var H=new k(()=>new et,i=>i.reset());class et{constructor(){this.next=this.g=this.h=null}set(c,u){this.h=c,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let ft,at=!1,v=new U,m=()=>{const i=Promise.resolve(void 0);ft=()=>{i.then(_)}};function _(){for(var i;i=B();){try{i.h.call(i.g)}catch(u){V(u)}var c=H;c.j(i),c.h<100&&(c.h++,i.next=c.g,c.g=i)}at=!1}function T(){this.u=this.u,this.C=this.C}T.prototype.u=!1,T.prototype.dispose=function(){this.u||(this.u=!0,this.N())},T.prototype[Symbol.dispose]=function(){this.dispose()},T.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var w=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const u=()=>{};a.addEventListener("test",u,c),a.removeEventListener("test",u,c)}catch{}return i}();function g(i){return/^[\s\xa0]*$/.test(i)}function Et(i,c){E.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,c)}y(Et,E),Et.prototype.init=function(i,c){const u=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget,c||(u=="mouseover"?c=i.fromElement:u=="mouseout"&&(c=i.toElement)),this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&Et.Z.h.call(this)},Et.prototype.h=function(){Et.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var Lt="closure_listenable_"+(Math.random()*1e6|0),dn=0;function nr(i,c,u,f,I){this.listener=i,this.proxy=null,this.src=c,this.type=u,this.capture=!!f,this.ha=I,this.key=++dn,this.da=this.fa=!1}function Fe(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function D(i,c,u){for(const f in i)c.call(u,i[f],f,i)}function L(i,c){for(const u in i)c.call(void 0,i[u],u,i)}function G(i){const c={};for(const u in i)c[u]=i[u];return c}const tt="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function O(i,c){let u,f;for(let I=1;I<arguments.length;I++){f=arguments[I];for(u in f)i[u]=f[u];for(let b=0;b<tt.length;b++)u=tt[b],Object.prototype.hasOwnProperty.call(f,u)&&(i[u]=f[u])}}function Y(i){this.src=i,this.g={},this.h=0}Y.prototype.add=function(i,c,u,f,I){const b=i.toString();i=this.g[b],i||(i=this.g[b]=[],this.h++);const P=wt(i,c,f,I);return P>-1?(c=i[P],u||(c.fa=!1)):(c=new nr(c,this.src,b,!!f,I),c.fa=u,i.push(c)),c};function j(i,c){const u=c.type;if(u in i.g){var f=i.g[u],I=Array.prototype.indexOf.call(f,c,void 0),b;(b=I>=0)&&Array.prototype.splice.call(f,I,1),b&&(Fe(c),i.g[u].length==0&&(delete i.g[u],i.h--))}}function wt(i,c,u,f){for(let I=0;I<i.length;++I){const b=i[I];if(!b.da&&b.listener==c&&b.capture==!!u&&b.ha==f)return I}return-1}var xt="closure_lm_"+(Math.random()*1e6|0),Qt={};function ne(i,c,u,f,I){if(Array.isArray(c)){for(let b=0;b<c.length;b++)ne(i,c[b],u,f,I);return null}return u=zi(u),i&&i[Lt]?i.J(c,u,l(f)?!!f.capture:!1,I):Xt(i,c,u,!1,f,I)}function Xt(i,c,u,f,I,b){if(!c)throw Error("Invalid event type");const P=l(I)?!!I.capture:!!I;let K=is(i);if(K||(i[xt]=K=new Y(i)),u=K.add(c,u,f,P,b),u.proxy)return u;if(f=Yt(),u.proxy=f,f.src=i,f.listener=u,i.addEventListener)w||(I=P),I===void 0&&(I=!1),i.addEventListener(c.toString(),f,I);else if(i.attachEvent)i.attachEvent(Ue(c.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return u}function Yt(){function i(u){return c.call(i.src,i.listener,u)}const c=fn;return i}function Be(i,c,u,f,I){if(Array.isArray(c))for(var b=0;b<c.length;b++)Be(i,c[b],u,f,I);else f=l(f)?!!f.capture:!!f,u=zi(u),i&&i[Lt]?(i=i.i,b=String(c).toString(),b in i.g&&(c=i.g[b],u=wt(c,u,f,I),u>-1&&(Fe(c[u]),Array.prototype.splice.call(c,u,1),c.length==0&&(delete i.g[b],i.h--)))):i&&(i=is(i))&&(c=i.g[c.toString()],i=-1,c&&(i=wt(c,u,f,I)),(u=i>-1?c[i]:null)&&Te(u))}function Te(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[Lt])j(c.i,i);else{var u=i.type,f=i.proxy;c.removeEventListener?c.removeEventListener(u,f,i.capture):c.detachEvent?c.detachEvent(Ue(u),f):c.addListener&&c.removeListener&&c.removeListener(f),(u=is(c))?(j(u,i),u.h==0&&(u.src=null,c[xt]=null)):Fe(i)}}}function Ue(i){return i in Qt?Qt[i]:Qt[i]="on"+i}function fn(i,c){if(i.da)i=!0;else{c=new Et(c,this);const u=i.listener,f=i.ha||i.src;i.fa&&Te(i),i=u.call(f,c)}return i}function is(i){return i=i[xt],i instanceof Y?i:null}var os="__closure_events_fn_"+(Math.random()*1e9>>>0);function zi(i){return typeof i=="function"?i:(i[os]||(i[os]=function(c){return i.handleEvent(c)}),i[os])}function St(){T.call(this),this.i=new Y(this),this.M=this,this.G=null}y(St,T),St.prototype[Lt]=!0,St.prototype.removeEventListener=function(i,c,u,f){Be(this,i,c,u,f)};function Vt(i,c){var u,f=i.G;if(f)for(u=[];f;f=f.G)u.push(f);if(i=i.M,f=c.type||c,typeof c=="string")c=new E(c,i);else if(c instanceof E)c.target=c.target||i;else{var I=c;c=new E(f,i),O(c,I)}I=!0;let b,P;if(u)for(P=u.length-1;P>=0;P--)b=c.g=u[P],I=rr(b,f,!0,c)&&I;if(b=c.g=i,I=rr(b,f,!0,c)&&I,I=rr(b,f,!1,c)&&I,u)for(P=0;P<u.length;P++)b=c.g=u[P],I=rr(b,f,!1,c)&&I}St.prototype.N=function(){if(St.Z.N.call(this),this.i){var i=this.i;for(const c in i.g){const u=i.g[c];for(let f=0;f<u.length;f++)Fe(u[f]);delete i.g[c],i.h--}}this.G=null},St.prototype.J=function(i,c,u,f){return this.i.add(String(i),c,!1,u,f)},St.prototype.K=function(i,c,u,f){return this.i.add(String(i),c,!0,u,f)};function rr(i,c,u,f){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();let I=!0;for(let b=0;b<c.length;++b){const P=c[b];if(P&&!P.da&&P.capture==u){const K=P.listener,mt=P.ha||P.src;P.fa&&j(i.i,P),I=K.call(mt,f)!==!1&&I}}return I&&!f.defaultPrevented}function Wu(i,c){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(i,c||0)}function $i(i){i.g=Wu(()=>{i.g=null,i.i&&(i.i=!1,$i(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class Qu extends T{constructor(c,u){super(),this.m=c,this.l=u,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:$i(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function mn(i){T.call(this),this.h=i,this.g={}}y(mn,T);var Hi=[];function Gi(i){D(i.g,function(c,u){this.g.hasOwnProperty(u)&&Te(c)},i),i.g={}}mn.prototype.N=function(){mn.Z.N.call(this),Gi(this)},mn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var as=a.JSON.stringify,Xu=a.JSON.parse,Yu=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function Ki(){}function Wi(){}var pn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function cs(){E.call(this,"d")}y(cs,E);function us(){E.call(this,"c")}y(us,E);var we={},Qi=null;function sr(){return Qi=Qi||new St}we.Ia="serverreachability";function Xi(i){E.call(this,we.Ia,i)}y(Xi,E);function gn(i){const c=sr();Vt(c,new Xi(c))}we.STAT_EVENT="statevent";function Yi(i,c){E.call(this,we.STAT_EVENT,i),this.stat=c}y(Yi,E);function Dt(i){const c=sr();Vt(c,new Yi(c,i))}we.Ja="timingevent";function Ji(i,c){E.call(this,we.Ja,i),this.size=c}y(Ji,E);function _n(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},c)}function yn(){this.g=!0}yn.prototype.ua=function(){this.g=!1};function Ju(i,c,u,f,I,b){i.info(function(){if(i.g)if(b){var P="",K=b.split("&");for(let rt=0;rt<K.length;rt++){var mt=K[rt].split("=");if(mt.length>1){const vt=mt[0];mt=mt[1];const Ut=vt.split("_");P=Ut.length>=2&&Ut[1]=="type"?P+(vt+"="+mt+"&"):P+(vt+"=redacted&")}}}else P=null;else P=b;return"XMLHTTP REQ ("+f+") [attempt "+I+"]: "+c+`
`+u+`
`+P})}function Zu(i,c,u,f,I,b,P){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+I+"]: "+c+`
`+u+`
`+b+" "+P})}function qe(i,c,u,f){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+el(i,u)+(f?" "+f:"")})}function tl(i,c){i.info(function(){return"TIMEOUT: "+c})}yn.prototype.info=function(){};function el(i,c){if(!i.g)return c;if(!c)return null;try{const b=JSON.parse(c);if(b){for(i=0;i<b.length;i++)if(Array.isArray(b[i])){var u=b[i];if(!(u.length<2)){var f=u[1];if(Array.isArray(f)&&!(f.length<1)){var I=f[0];if(I!="noop"&&I!="stop"&&I!="close")for(let P=1;P<f.length;P++)f[P]=""}}}}return as(b)}catch{return c}}var ir={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Zi={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},to;function ls(){}y(ls,Ki),ls.prototype.g=function(){return new XMLHttpRequest},to=new ls;function En(i){return encodeURIComponent(String(i))}function nl(i){var c=1;i=i.split(":");const u=[];for(;c>0&&i.length;)u.push(i.shift()),c--;return i.length&&u.push(i.join(":")),u}function re(i,c,u,f){this.j=i,this.i=c,this.l=u,this.S=f||1,this.V=new mn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new eo}function eo(){this.i=null,this.g="",this.h=!1}var no={},hs={};function ds(i,c,u){i.M=1,i.A=ar(Bt(c)),i.u=u,i.R=!0,ro(i,null)}function ro(i,c){i.F=Date.now(),or(i),i.B=Bt(i.A);var u=i.B,f=i.S;Array.isArray(f)||(f=[String(f)]),_o(u.i,"t",f),i.C=0,u=i.j.L,i.h=new eo,i.g=Mo(i.j,u?c:null,!i.u),i.P>0&&(i.O=new Qu(d(i.Y,i,i.g),i.P)),c=i.V,u=i.g,f=i.ba;var I="readystatechange";Array.isArray(I)||(I&&(Hi[0]=I.toString()),I=Hi);for(let b=0;b<I.length;b++){const P=ne(u,I[b],f||c.handleEvent,!1,c.h||c);if(!P)break;c.g[P.key]=P}c=i.J?G(i.J):{},i.u?(i.v||(i.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,c)):(i.v="GET",i.g.ea(i.B,i.v,null,c)),gn(),Ju(i.i,i.v,i.B,i.l,i.S,i.u)}re.prototype.ba=function(i){i=i.target;const c=this.O;c&&oe(i)==3?c.j():this.Y(i)},re.prototype.Y=function(i){try{if(i==this.g)t:{const K=oe(this.g),mt=this.g.ya(),rt=this.g.ca();if(!(K<3)&&(K!=3||this.g&&(this.h.h||this.g.la()||Ao(this.g)))){this.K||K!=4||mt==7||(mt==8||rt<=0?gn(3):gn(2)),fs(this);var c=this.g.ca();this.X=c;var u=rl(this);if(this.o=c==200,Zu(this.i,this.v,this.B,this.l,this.S,K,c),this.o){if(this.U&&!this.L){e:{if(this.g){var f,I=this.g;if((f=I.g?I.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(f)){var b=f;break e}}b=null}if(i=b)qe(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,ms(this,i);else{this.o=!1,this.m=3,Dt(12),Ie(this),vn(this);break t}}if(this.R){i=!0;let vt;for(;!this.K&&this.C<u.length;)if(vt=sl(this,u),vt==hs){K==4&&(this.m=4,Dt(14),i=!1),qe(this.i,this.l,null,"[Incomplete Response]");break}else if(vt==no){this.m=4,Dt(15),qe(this.i,this.l,u,"[Invalid Chunk]"),i=!1;break}else qe(this.i,this.l,vt,null),ms(this,vt);if(so(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),K!=4||u.length!=0||this.h.h||(this.m=1,Dt(16),i=!1),this.o=this.o&&i,!i)qe(this.i,this.l,u,"[Invalid Chunked Response]"),Ie(this),vn(this);else if(u.length>0&&!this.W){this.W=!0;var P=this.j;P.g==this&&P.aa&&!P.P&&(P.j.info("Great, no buffering proxy detected. Bytes received: "+u.length),ws(P),P.P=!0,Dt(11))}}else qe(this.i,this.l,u,null),ms(this,u);K==4&&Ie(this),this.o&&!this.K&&(K==4?Do(this.j,this):(this.o=!1,or(this)))}else yl(this.g),c==400&&u.indexOf("Unknown SID")>0?(this.m=3,Dt(12)):(this.m=0,Dt(13)),Ie(this),vn(this)}}}catch{}finally{}};function rl(i){if(!so(i))return i.g.la();const c=Ao(i.g);if(c==="")return"";let u="";const f=c.length,I=oe(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return Ie(i),vn(i),"";i.h.i=new a.TextDecoder}for(let b=0;b<f;b++)i.h.h=!0,u+=i.h.i.decode(c[b],{stream:!(I&&b==f-1)});return c.length=0,i.h.g+=u,i.C=0,i.h.g}function so(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function sl(i,c){var u=i.C,f=c.indexOf(`
`,u);return f==-1?hs:(u=Number(c.substring(u,f)),isNaN(u)?no:(f+=1,f+u>c.length?hs:(c=c.slice(f,f+u),i.C=f+u,c)))}re.prototype.cancel=function(){this.K=!0,Ie(this)};function or(i){i.T=Date.now()+i.H,io(i,i.H)}function io(i,c){if(i.D!=null)throw Error("WatchDog timer not null");i.D=_n(d(i.aa,i),c)}function fs(i){i.D&&(a.clearTimeout(i.D),i.D=null)}re.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(tl(this.i,this.B),this.M!=2&&(gn(),Dt(17)),Ie(this),this.m=2,vn(this)):io(this,this.T-i)};function vn(i){i.j.I==0||i.K||Do(i.j,i)}function Ie(i){fs(i);var c=i.O;c&&typeof c.dispose=="function"&&c.dispose(),i.O=null,Gi(i.V),i.g&&(c=i.g,i.g=null,c.abort(),c.dispose())}function ms(i,c){try{var u=i.j;if(u.I!=0&&(u.g==i||ps(u.h,i))){if(!i.L&&ps(u.h,i)&&u.I==3){try{var f=u.Ba.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var I=f;if(I[0]==0){t:if(!u.v){if(u.g)if(u.g.F+3e3<i.F)dr(u),lr(u);else break t;Ts(u),Dt(18)}}else u.xa=I[1],0<u.xa-u.K&&I[2]<37500&&u.F&&u.A==0&&!u.C&&(u.C=_n(d(u.Va,u),6e3));co(u.h)<=1&&u.ta&&(u.ta=void 0)}else be(u,11)}else if((i.L||u.g==i)&&dr(u),!g(c))for(I=u.Ba.g.parse(c),c=0;c<I.length;c++){let rt=I[c];const vt=rt[0];if(!(vt<=u.K))if(u.K=vt,rt=rt[1],u.I==2)if(rt[0]=="c"){u.M=rt[1],u.ba=rt[2];const Ut=rt[3];Ut!=null&&(u.ka=Ut,u.j.info("VER="+u.ka));const Se=rt[4];Se!=null&&(u.za=Se,u.j.info("SVER="+u.za));const ae=rt[5];ae!=null&&typeof ae=="number"&&ae>0&&(f=1.5*ae,u.O=f,u.j.info("backChannelRequestTimeoutMs_="+f)),f=u;const ce=i.g;if(ce){const mr=ce.g?ce.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(mr){var b=f.h;b.g||mr.indexOf("spdy")==-1&&mr.indexOf("quic")==-1&&mr.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(gs(b,b.h),b.h=null))}if(f.G){const Is=ce.g?ce.g.getResponseHeader("X-HTTP-Session-Id"):null;Is&&(f.wa=Is,st(f.J,f.G,Is))}}u.I=3,u.l&&u.l.ra(),u.aa&&(u.T=Date.now()-i.F,u.j.info("Handshake RTT: "+u.T+"ms")),f=u;var P=i;if(f.na=ko(f,f.L?f.ba:null,f.W),P.L){uo(f.h,P);var K=P,mt=f.O;mt&&(K.H=mt),K.D&&(fs(K),or(K)),f.g=P}else Po(f);u.i.length>0&&hr(u)}else rt[0]!="stop"&&rt[0]!="close"||be(u,7);else u.I==3&&(rt[0]=="stop"||rt[0]=="close"?rt[0]=="stop"?be(u,7):vs(u):rt[0]!="noop"&&u.l&&u.l.qa(rt),u.A=0)}}gn(4)}catch{}}var il=class{constructor(i,c){this.g=i,this.map=c}};function oo(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ao(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function co(i){return i.h?1:i.g?i.g.size:0}function ps(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function gs(i,c){i.g?i.g.add(c):i.h=c}function uo(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}oo.prototype.cancel=function(){if(this.i=lo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function lo(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const u of i.g.values())c=c.concat(u.G);return c}return R(i.i)}var ho=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ol(i,c){if(i){i=i.split("&");for(let u=0;u<i.length;u++){const f=i[u].indexOf("=");let I,b=null;f>=0?(I=i[u].substring(0,f),b=i[u].substring(f+1)):I=i[u],c(I,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function se(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;i instanceof se?(this.l=i.l,Tn(this,i.j),this.o=i.o,this.g=i.g,wn(this,i.u),this.h=i.h,_s(this,yo(i.i)),this.m=i.m):i&&(c=String(i).match(ho))?(this.l=!1,Tn(this,c[1]||"",!0),this.o=In(c[2]||""),this.g=In(c[3]||"",!0),wn(this,c[4]),this.h=In(c[5]||"",!0),_s(this,c[6]||"",!0),this.m=In(c[7]||"")):(this.l=!1,this.i=new bn(null,this.l))}se.prototype.toString=function(){const i=[];var c=this.j;c&&i.push(An(c,fo,!0),":");var u=this.g;return(u||c=="file")&&(i.push("//"),(c=this.o)&&i.push(An(c,fo,!0),"@"),i.push(En(u).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.u,u!=null&&i.push(":",String(u))),(u=this.h)&&(this.g&&u.charAt(0)!="/"&&i.push("/"),i.push(An(u,u.charAt(0)=="/"?ul:cl,!0))),(u=this.i.toString())&&i.push("?",u),(u=this.m)&&i.push("#",An(u,hl)),i.join("")},se.prototype.resolve=function(i){const c=Bt(this);let u=!!i.j;u?Tn(c,i.j):u=!!i.o,u?c.o=i.o:u=!!i.g,u?c.g=i.g:u=i.u!=null;var f=i.h;if(u)wn(c,i.u);else if(u=!!i.h){if(f.charAt(0)!="/")if(this.g&&!this.h)f="/"+f;else{var I=c.h.lastIndexOf("/");I!=-1&&(f=c.h.slice(0,I+1)+f)}if(I=f,I==".."||I==".")f="";else if(I.indexOf("./")!=-1||I.indexOf("/.")!=-1){f=I.lastIndexOf("/",0)==0,I=I.split("/");const b=[];for(let P=0;P<I.length;){const K=I[P++];K=="."?f&&P==I.length&&b.push(""):K==".."?((b.length>1||b.length==1&&b[0]!="")&&b.pop(),f&&P==I.length&&b.push("")):(b.push(K),f=!0)}f=b.join("/")}else f=I}return u?c.h=f:u=i.i.toString()!=="",u?_s(c,yo(i.i)):u=!!i.m,u&&(c.m=i.m),c};function Bt(i){return new se(i)}function Tn(i,c,u){i.j=u?In(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function wn(i,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);i.u=c}else i.u=null}function _s(i,c,u){c instanceof bn?(i.i=c,dl(i.i,i.l)):(u||(c=An(c,ll)),i.i=new bn(c,i.l))}function st(i,c,u){i.i.set(c,u)}function ar(i){return st(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function In(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function An(i,c,u){return typeof i=="string"?(i=encodeURI(i).replace(c,al),u&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function al(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var fo=/[#\/\?@]/g,cl=/[#\?:]/g,ul=/[#\?]/g,ll=/[#\?@]/g,hl=/#/g;function bn(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function Ae(i){i.g||(i.g=new Map,i.h=0,i.i&&ol(i.i,function(c,u){i.add(decodeURIComponent(c.replace(/\+/g," ")),u)}))}n=bn.prototype,n.add=function(i,c){Ae(this),this.i=null,i=je(this,i);let u=this.g.get(i);return u||this.g.set(i,u=[]),u.push(c),this.h+=1,this};function mo(i,c){Ae(i),c=je(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function po(i,c){return Ae(i),c=je(i,c),i.g.has(c)}n.forEach=function(i,c){Ae(this),this.g.forEach(function(u,f){u.forEach(function(I){i.call(c,I,f,this)},this)},this)};function go(i,c){Ae(i);let u=[];if(typeof c=="string")po(i,c)&&(u=u.concat(i.g.get(je(i,c))));else for(i=Array.from(i.g.values()),c=0;c<i.length;c++)u=u.concat(i[c]);return u}n.set=function(i,c){return Ae(this),this.i=null,i=je(this,i),po(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=go(this,i),i.length>0?String(i[0]):c):c};function _o(i,c,u){mo(i,c),u.length>0&&(i.i=null,i.g.set(je(i,c),R(u)),i.h+=u.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(let f=0;f<c.length;f++){var u=c[f];const I=En(u);u=go(this,u);for(let b=0;b<u.length;b++){let P=I;u[b]!==""&&(P+="="+En(u[b])),i.push(P)}}return this.i=i.join("&")};function yo(i){const c=new bn;return c.i=i.i,i.g&&(c.g=new Map(i.g),c.h=i.h),c}function je(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function dl(i,c){c&&!i.j&&(Ae(i),i.i=null,i.g.forEach(function(u,f){const I=f.toLowerCase();f!=I&&(mo(this,f),_o(this,I,u))},i)),i.j=c}function fl(i,c){const u=new yn;if(a.Image){const f=new Image;f.onload=p(ie,u,"TestLoadImage: loaded",!0,c,f),f.onerror=p(ie,u,"TestLoadImage: error",!1,c,f),f.onabort=p(ie,u,"TestLoadImage: abort",!1,c,f),f.ontimeout=p(ie,u,"TestLoadImage: timeout",!1,c,f),a.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else c(!1)}function ml(i,c){const u=new yn,f=new AbortController,I=setTimeout(()=>{f.abort(),ie(u,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:f.signal}).then(b=>{clearTimeout(I),b.ok?ie(u,"TestPingServer: ok",!0,c):ie(u,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(I),ie(u,"TestPingServer: error",!1,c)})}function ie(i,c,u,f,I){try{I&&(I.onload=null,I.onerror=null,I.onabort=null,I.ontimeout=null),f(u)}catch{}}function pl(){this.g=new Yu}function ys(i){this.i=i.Sb||null,this.h=i.ab||!1}y(ys,Ki),ys.prototype.g=function(){return new cr(this.i,this.h)};function cr(i,c){St.call(this),this.H=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}y(cr,St),n=cr.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=c,this.readyState=1,Rn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(c.body=i),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Sn(this)),this.readyState=0},n.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Rn(this)),this.g&&(this.readyState=3,Rn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Eo(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function Eo(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}n.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?Sn(this):Rn(this),this.readyState==3&&Eo(this)}},n.Oa=function(i){this.g&&(this.response=this.responseText=i,Sn(this))},n.Na=function(i){this.g&&(this.response=i,Sn(this))},n.ga=function(){this.g&&Sn(this)};function Sn(i){i.readyState=4,i.l=null,i.j=null,i.B=null,Rn(i)}n.setRequestHeader=function(i,c){this.A.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var u=c.next();!u.done;)u=u.value,i.push(u[0]+": "+u[1]),u=c.next();return i.join(`\r
`)};function Rn(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(cr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function vo(i){let c="";return D(i,function(u,f){c+=f,c+=":",c+=u,c+=`\r
`}),c}function Es(i,c,u){t:{for(f in u){var f=!1;break t}f=!0}f||(u=vo(u),typeof i=="string"?u!=null&&En(u):st(i,c,u))}function ut(i){St.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}y(ut,St);var gl=/^https?$/i,_l=["POST","PUT"];n=ut.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,c,u,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():to.g(),this.g.onreadystatechange=A(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(b){To(this,b);return}if(i=u||"",u=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var I in f)u.set(I,f[I]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const b of f.keys())u.set(b,f.get(b));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(u.keys()).find(b=>b.toLowerCase()=="content-type"),I=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(_l,c,void 0)>=0)||f||I||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,P]of u)this.g.setRequestHeader(b,P);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(b){To(this,b)}};function To(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.o=5,wo(i),ur(i)}function wo(i){i.A||(i.A=!0,Vt(i,"complete"),Vt(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,Vt(this,"complete"),Vt(this,"abort"),ur(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ur(this,!0)),ut.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?Io(this):this.Xa())},n.Xa=function(){Io(this)};function Io(i){if(i.h&&typeof o<"u"){if(i.v&&oe(i)==4)setTimeout(i.Ca.bind(i),0);else if(Vt(i,"readystatechange"),oe(i)==4){i.h=!1;try{const b=i.ca();t:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break t;default:c=!1}var u;if(!(u=c)){var f;if(f=b===0){let P=String(i.D).match(ho)[1]||null;!P&&a.self&&a.self.location&&(P=a.self.location.protocol.slice(0,-1)),f=!gl.test(P?P.toLowerCase():"")}u=f}if(u)Vt(i,"complete"),Vt(i,"success");else{i.o=6;try{var I=oe(i)>2?i.g.statusText:""}catch{I=""}i.l=I+" ["+i.ca()+"]",wo(i)}}finally{ur(i)}}}}function ur(i,c){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const u=i.g;i.g=null,c||Vt(i,"ready");try{u.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function oe(i){return i.g?i.g.readyState:0}n.ca=function(){try{return oe(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),Xu(c)}};function Ao(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function yl(i){const c={};i=(i.g&&oe(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(g(i[f]))continue;var u=nl(i[f]);const I=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const b=c[I]||[];c[I]=b,b.push(u)}L(c,function(f){return f.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Cn(i,c,u){return u&&u.internalChannelParams&&u.internalChannelParams[i]||c}function bo(i){this.za=0,this.i=[],this.j=new yn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Cn("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Cn("baseRetryDelayMs",5e3,i),this.Za=Cn("retryDelaySeedMs",1e4,i),this.Ta=Cn("forwardChannelMaxRetries",2,i),this.va=Cn("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new oo(i&&i.concurrentRequestLimit),this.Ba=new pl,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=bo.prototype,n.ka=8,n.I=1,n.connect=function(i,c,u,f){Dt(0),this.W=i,this.H=c||{},u&&f!==void 0&&(this.H.OSID=u,this.H.OAID=f),this.F=this.X,this.J=ko(this,null,this.W),hr(this)};function vs(i){if(So(i),i.I==3){var c=i.V++,u=Bt(i.J);if(st(u,"SID",i.M),st(u,"RID",c),st(u,"TYPE","terminate"),Pn(i,u),c=new re(i,i.j,c),c.M=2,c.A=ar(Bt(u)),u=!1,a.navigator&&a.navigator.sendBeacon)try{u=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!u&&a.Image&&(new Image().src=c.A,u=!0),u||(c.g=Mo(c.j,null),c.g.ea(c.A)),c.F=Date.now(),or(c)}No(i)}function lr(i){i.g&&(ws(i),i.g.cancel(),i.g=null)}function So(i){lr(i),i.v&&(a.clearTimeout(i.v),i.v=null),dr(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function hr(i){if(!ao(i.h)&&!i.m){i.m=!0;var c=i.Ea;ft||m(),at||(ft(),at=!0),v.add(c,i),i.D=0}}function El(i,c){return co(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=c.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=_n(d(i.Ea,i,c),xo(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const I=new re(this,this.j,i);let b=this.o;if(this.U&&(b?(b=G(b),O(b,this.U)):b=this.U),this.u!==null||this.R||(I.J=b,b=null),this.S)t:{for(var c=0,u=0;u<this.i.length;u++){e:{var f=this.i[u];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break e}f=void 0}if(f===void 0)break;if(c+=f,c>4096){c=u;break t}if(c===4096||u===this.i.length-1){c=u+1;break t}}c=1e3}else c=1e3;c=Co(this,I,c),u=Bt(this.J),st(u,"RID",i),st(u,"CVER",22),this.G&&st(u,"X-HTTP-Session-Id",this.G),Pn(this,u),b&&(this.R?c="headers="+En(vo(b))+"&"+c:this.u&&Es(u,this.u,b)),gs(this.h,I),this.Ra&&st(u,"TYPE","init"),this.S?(st(u,"$req",c),st(u,"SID","null"),I.U=!0,ds(I,u,null)):ds(I,u,c),this.I=2}}else this.I==3&&(i?Ro(this,i):this.i.length==0||ao(this.h)||Ro(this))};function Ro(i,c){var u;c?u=c.l:u=i.V++;const f=Bt(i.J);st(f,"SID",i.M),st(f,"RID",u),st(f,"AID",i.K),Pn(i,f),i.u&&i.o&&Es(f,i.u,i.o),u=new re(i,i.j,u,i.D+1),i.u===null&&(u.J=i.o),c&&(i.i=c.G.concat(i.i)),c=Co(i,u,1e3),u.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),gs(i.h,u),ds(u,f,c)}function Pn(i,c){i.H&&D(i.H,function(u,f){st(c,f,u)}),i.l&&D({},function(u,f){st(c,f,u)})}function Co(i,c,u){u=Math.min(i.i.length,u);const f=i.l?d(i.l.Ka,i.l,i):null;t:{var I=i.i;let K=-1;for(;;){const mt=["count="+u];K==-1?u>0?(K=I[0].g,mt.push("ofs="+K)):K=0:mt.push("ofs="+K);let rt=!0;for(let vt=0;vt<u;vt++){var b=I[vt].g;const Ut=I[vt].map;if(b-=K,b<0)K=Math.max(0,I[vt].g-100),rt=!1;else try{b="req"+b+"_"||"";try{var P=Ut instanceof Map?Ut:Object.entries(Ut);for(const[Se,ae]of P){let ce=ae;l(ae)&&(ce=as(ae)),mt.push(b+Se+"="+encodeURIComponent(ce))}}catch(Se){throw mt.push(b+"type="+encodeURIComponent("_badmap")),Se}}catch{f&&f(Ut)}}if(rt){P=mt.join("&");break t}}P=void 0}return i=i.i.splice(0,u),c.G=i,P}function Po(i){if(!i.g&&!i.v){i.Y=1;var c=i.Da;ft||m(),at||(ft(),at=!0),v.add(c,i),i.A=0}}function Ts(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=_n(d(i.Da,i),xo(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,Vo(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=_n(d(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Dt(10),lr(this),Vo(this))};function ws(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function Vo(i){i.g=new re(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var c=Bt(i.na);st(c,"RID","rpc"),st(c,"SID",i.M),st(c,"AID",i.K),st(c,"CI",i.F?"0":"1"),!i.F&&i.ia&&st(c,"TO",i.ia),st(c,"TYPE","xmlhttp"),Pn(i,c),i.u&&i.o&&Es(c,i.u,i.o),i.O&&(i.g.H=i.O);var u=i.g;i=i.ba,u.M=1,u.A=ar(Bt(c)),u.u=null,u.R=!0,ro(u,i)}n.Va=function(){this.C!=null&&(this.C=null,lr(this),Ts(this),Dt(19))};function dr(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function Do(i,c){var u=null;if(i.g==c){dr(i),ws(i),i.g=null;var f=2}else if(ps(i.h,c))u=c.G,uo(i.h,c),f=1;else return;if(i.I!=0){if(c.o)if(f==1){u=c.u?c.u.length:0,c=Date.now()-c.F;var I=i.D;f=sr(),Vt(f,new Ji(f,u)),hr(i)}else Po(i);else if(I=c.m,I==3||I==0&&c.X>0||!(f==1&&El(i,c)||f==2&&Ts(i)))switch(u&&u.length>0&&(c=i.h,c.i=c.i.concat(u)),I){case 1:be(i,5);break;case 4:be(i,10);break;case 3:be(i,6);break;default:be(i,2)}}}function xo(i,c){let u=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(u*=2),u*c}function be(i,c){if(i.j.info("Error code "+c),c==2){var u=d(i.bb,i),f=i.Ua;const I=!f;f=new se(f||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Tn(f,"https"),ar(f),I?fl(f.toString(),u):ml(f.toString(),u)}else Dt(2);i.I=0,i.l&&i.l.pa(c),No(i),So(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),Dt(2)):(this.j.info("Failed to ping google.com"),Dt(1))};function No(i){if(i.I=0,i.ja=[],i.l){const c=lo(i.h);(c.length!=0||i.i.length!=0)&&(N(i.ja,c),N(i.ja,i.i),i.h.i.length=0,R(i.i),i.i.length=0),i.l.oa()}}function ko(i,c,u){var f=u instanceof se?Bt(u):new se(u);if(f.g!="")c&&(f.g=c+"."+f.g),wn(f,f.u);else{var I=a.location;f=I.protocol,c=c?c+"."+I.hostname:I.hostname,I=+I.port;const b=new se(null);f&&Tn(b,f),c&&(b.g=c),I&&wn(b,I),u&&(b.h=u),f=b}return u=i.G,c=i.wa,u&&c&&st(f,u,c),st(f,"VER",i.ka),Pn(i,f),f}function Mo(i,c,u){if(c&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Aa&&!i.ma?new ut(new ys({ab:u})):new ut(i.ma),c.Fa(i.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Oo(){}n=Oo.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function fr(){}fr.prototype.g=function(i,c){return new kt(i,c)};function kt(i,c){St.call(this),this.g=new bo(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(i?i["X-WebChannel-Client-Profile"]=c.sa:i={"X-WebChannel-Client-Profile":c.sa}),this.g.U=i,(i=c&&c.Qb)&&!g(i)&&(this.g.u=i),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!g(c)&&(this.g.G=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new ze(this)}y(kt,St),kt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},kt.prototype.close=function(){vs(this.g)},kt.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var u={};u.__data__=i,i=u}else this.v&&(u={},u.__data__=as(i),i=u);c.i.push(new il(c.Ya++,i)),c.I==3&&hr(c)},kt.prototype.N=function(){this.g.l=null,delete this.j,vs(this.g),delete this.g,kt.Z.N.call(this)};function Lo(i){cs.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){t:{for(const u in c){i=u;break t}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}y(Lo,cs);function Fo(){us.call(this),this.status=1}y(Fo,us);function ze(i){this.g=i}y(ze,Oo),ze.prototype.ra=function(){Vt(this.g,"a")},ze.prototype.qa=function(i){Vt(this.g,new Lo(i))},ze.prototype.pa=function(i){Vt(this.g,new Fo)},ze.prototype.oa=function(){Vt(this.g,"b")},fr.prototype.createWebChannel=fr.prototype.g,kt.prototype.send=kt.prototype.o,kt.prototype.open=kt.prototype.m,kt.prototype.close=kt.prototype.close,gc=function(){return new fr},pc=function(){return sr()},mc=we,$s={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},ir.NO_ERROR=0,ir.TIMEOUT=8,ir.HTTP_ERROR=6,Ir=ir,Zi.COMPLETE="complete",fc=Zi,Wi.EventType=pn,pn.OPEN="a",pn.CLOSE="b",pn.ERROR="c",pn.MESSAGE="d",St.prototype.listen=St.prototype.J,Vn=Wi,ut.prototype.listenOnce=ut.prototype.K,ut.prototype.getLastError=ut.prototype.Ha,ut.prototype.getLastErrorCode=ut.prototype.ya,ut.prototype.getStatus=ut.prototype.ca,ut.prototype.getResponseJson=ut.prototype.La,ut.prototype.getResponseText=ut.prototype.la,ut.prototype.send=ut.prototype.ea,ut.prototype.setWithCredentials=ut.prototype.Fa,dc=ut}).apply(typeof yr<"u"?yr:typeof self<"u"?self:typeof window<"u"?window:{});const Zo="@firebase/firestore",ta="4.9.3";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De=new ic("@firebase/firestore");function $e(){return De.logLevel}function x(n,...t){if(De.logLevel<=Z.DEBUG){const e=t.map(hi);De.debug(`Firestore (${cn}): ${n}`,...e)}}function te(n,...t){if(De.logLevel<=Z.ERROR){const e=t.map(hi);De.error(`Firestore (${cn}): ${n}`,...e)}}function Ze(n,...t){if(De.logLevel<=Z.WARN){const e=t.map(hi);De.warn(`Firestore (${cn}): ${n}`,...e)}}function hi(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dt(n,t){const e={typeString:n};return t&&(e.value=t),e}function Wn(n,t){if(!vc(n))throw new M(C.INVALID_ARGUMENT,"JSON must be an object");let e;for(const r in t)if(t[r]){const s=t[r].typeString,o="value"in t[r]?{value:t[r].value}:void 0;if(!(r in n)){e=`JSON missing required field: '${r}'`;break}const a=n[r];if(s&&typeof a!==s){e=`JSON field '${r}' must be a ${s}.`;break}if(o!==void 0&&a!==o.value){e=`Expected '${r}' field to equal '${o.value}'`;break}}if(e)throw new M(C.INVALID_ARGUMENT,e);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(n){if(n.code!==C.FAILED_PRECONDITION||n.message!==Dd)throw n;x("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tc="";function Md(n){let t="";for(let e=0;e<n.length;e++)t.length>0&&(t=aa(t)),t=Od(n.get(e),t);return aa(t)}function Od(n,t){let e=t;const r=n.length;for(let s=0;s<r;s++){const o=n.charAt(s);switch(o){case"\0":e+="";break;case Tc:e+="";break;default:e+=o}}return e}function aa(n){return n+Tc+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ca(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function Ne(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function wc(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(t){this.comparator=t,this.data=new ct(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal((e,r)=>(t(e),!1))}forEachInRange(t,e){const r=this.data.getIteratorFrom(t[0]);for(;r.hasNext();){const s=r.getNext();if(this.comparator(s.key,t[1])>=0)return;e(s.key)}}forEachWhile(t,e){let r;for(r=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();r.hasNext();)if(!t(r.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new ua(this.data.getIterator())}getIteratorFrom(t){return new ua(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach(r=>{e=e.add(r)}),e}isEqual(t){if(!(t instanceof yt)||this.size!==t.size)return!1;const e=this.data.getIterator(),r=t.data.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(this.comparator(s,o)!==0)return!1}return!0}toArray(){const t=[];return this.forEach(e=>{t.push(e)}),t}toString(){const t=[];return this.forEach(e=>t.push(e)),"SortedSet("+t.toString()+")"}copy(t){const e=new yt(this.comparator);return e.data=t,e}}class ua{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ac="server_timestamp",bc="__type__",Sc="__previous_value__",Rc="__local_write_time__";function pi(n){var e,r;return((r=(((e=n==null?void 0:n.mapValue)==null?void 0:e.fields)||{})[bc])==null?void 0:r.stringValue)===Ac}function Wr(n){const t=n.mapValue.fields[Sc];return pi(t)?Wr(t):t}function zn(n){const t=ge(n.mapValue.fields[Rc].timestampValue);return new ot(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rf=new ct(F.comparator);function ee(){return rf}const Bc=new ct(F.comparator);function Dn(...n){let t=Bc;for(const e of n)t=t.insert(e.key,e);return t}function Uc(n){let t=Bc;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function Ce(){return Ln()}function qc(){return Ln()}function Ln(){return new ke(n=>n.toString(),(n,t)=>n.isEqual(t))}const sf=new ct(F.comparator),of=new yt(F.comparator);function X(...n){let t=of;for(const e of n)t=t.add(e);return t}const af=new yt(Q);function cf(){return af}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vi(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Nr(t)?"-0":t}}function jc(n){return{integerValue:""+n}}function uf(n,t){return kd(t)?jc(t):vi(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wf=new de([4294967295,4294967295],0);function wa(n){const t=Tf().encode(n),e=new hc;return e.update(t),new Uint8Array(e.digest())}function Ia(n){const t=new DataView(n.buffer),e=t.getUint32(0,!0),r=t.getUint32(4,!0),s=t.getUint32(8,!0),o=t.getUint32(12,!0);return[new de([e,r],0),new de([s,o],0)]}class Ii{constructor(t,e,r){if(this.bitmap=t,this.padding=e,this.hashCount=r,e<0||e>=8)throw new xn(`Invalid padding: ${e}`);if(r<0)throw new xn(`Invalid hash count: ${r}`);if(t.length>0&&this.hashCount===0)throw new xn(`Invalid hash count: ${r}`);if(t.length===0&&e!==0)throw new xn(`Invalid padding when bitmap length is 0: ${e}`);this.ge=8*t.length-e,this.pe=de.fromNumber(this.ge)}ye(t,e,r){let s=t.add(e.multiply(de.fromNumber(r)));return s.compare(wf)===1&&(s=new de([s.getBits(0),s.getBits(1)],0)),s.modulo(this.pe).toNumber()}we(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.ge===0)return!1;const e=wa(t),[r,s]=Ia(e);for(let o=0;o<this.hashCount;o++){const a=this.ye(r,s,o);if(!this.we(a))return!1}return!0}static create(t,e,r){const s=t%8==0?0:8-t%8,o=new Uint8Array(Math.ceil(t/8)),a=new Ii(o,s,e);return r.forEach(l=>a.insert(l)),a}insert(t){if(this.ge===0)return;const e=wa(t),[r,s]=Ia(e);for(let o=0;o<this.hashCount;o++){const a=this.ye(r,s,o);this.Se(a)}}Se(t){const e=Math.floor(t/8),r=t%8;this.bitmap[e]|=1<<r}}class xn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,Xn.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new ts(z.min(),s,new ct(Q),ee(),X())}}class Xn{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new Xn(r,e,X(),X(),X())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Nt.DEFAULT_COLLECTION_PERCENTILE=10,Nt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Nt.DEFAULT=new Nt(iu,Nt.DEFAULT_COLLECTION_PERCENTILE,Nt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Nt.DISABLED=new Nt(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xf{constructor(){this.changes=new ke(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,Pt.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?S.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jf{constructor(t,e,r,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=s}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(s=>(r=s,this.remoteDocumentCache.getEntry(t,e))).next(s=>(r!==null&&Fn(r.mutation,s,Ft.empty(),ot.now()),s))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,X()).next(()=>r))}getLocalViewOfDocuments(t,e,r=X()){const s=Ce();return this.populateOverlays(t,s,e).next(()=>this.computeViews(t,e,s,r).next(o=>{let a=Dn();return o.forEach((l,h)=>{a=a.insert(l,h.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=Ce();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,X()))}populateOverlays(t,e,r){const s=[];return r.forEach(o=>{e.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(t,s).next(o=>{o.forEach((a,l)=>{e.set(a,l)})})}computeViews(t,e,r,s){let o=ee();const a=Ln(),l=function(){return Ln()}();return e.forEach((h,d)=>{const p=r.get(d.key);s.has(d.key)&&(p===void 0||p.mutation instanceof Me)?o=o.insert(d.key,d):p!==void 0?(a.set(d.key,p.mutation.getFieldMask()),Fn(p.mutation,d,p.mutation.getFieldMask(),ot.now())):a.set(d.key,Ft.empty())}),this.recalculateAndSaveOverlays(t,o).next(h=>(h.forEach((d,p)=>a.set(d,p)),e.forEach((d,p)=>l.set(d,new Yf(p,a.get(d)??null))),l))}recalculateAndSaveOverlays(t,e){const r=Ln();let s=new ct((a,l)=>a-l),o=X();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const l of a)l.keys().forEach(h=>{const d=e.get(h);if(d===null)return;let p=r.get(h)||Ft.empty();p=l.applyToLocalView(d,p),r.set(h,p);const y=(s.get(l.batchId)||X()).add(h);s=s.insert(l.batchId,y)})}).next(()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const h=l.getNext(),d=h.key,p=h.value,y=qc();p.forEach(A=>{if(!o.has(A)){const R=Kc(e.get(A),r.get(A));R!==null&&y.set(A,R),o=o.add(A)}}),a.push(this.documentOverlayCache.saveOverlays(t,d,y))}return S.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,s){return function(a){return F.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):Zd(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,s):this.getDocumentsMatchingCollectionQuery(t,e,r,s)}getNextDocuments(t,e,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,s-o.size):S.resolve(Ce());let l=jn,h=o;return a.next(d=>S.forEach(d,(p,y)=>(l<y.largestBatchId&&(l=y.largestBatchId),o.get(p)?S.resolve():this.remoteDocumentCache.getEntry(t,p).next(A=>{h=h.insert(p,A)}))).next(()=>this.populateOverlays(t,d,o)).next(()=>this.computeViews(t,h,d,X())).next(p=>({batchId:l,changes:Uc(p)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new F(e)).next(r=>{let s=Dn();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(t,e,r,s){const o=e.collectionGroup;let a=Dn();return this.indexManager.getCollectionParents(t,o).next(l=>S.forEach(l,h=>{const d=function(y,A){return new Qr(A,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,d,r,s).next(p=>{p.forEach((y,A)=>{a=a.insert(y,A)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,s))).next(a=>{o.forEach((h,d)=>{const p=d.getKey();a.get(p)===null&&(a=a.insert(p,Pt.newInvalidDocument(p)))});let l=Dn();return a.forEach((h,d)=>{const p=o.get(h);p!==void 0&&Fn(p.mutation,d,Ft.empty(),ot.now()),Yr(e,d)&&(l=l.insert(h,d))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{constructor(){this.overlays=new ct(F.comparator),this.qr=new Map}getOverlay(t,e){return S.resolve(this.overlays.get(e))}getOverlays(t,e){const r=Ce();return S.forEach(e,s=>this.getOverlay(t,s).next(o=>{o!==null&&r.set(s,o)})).next(()=>r)}saveOverlays(t,e,r){return r.forEach((s,o)=>{this.St(t,e,o)}),S.resolve()}removeOverlaysForBatchId(t,e,r){const s=this.qr.get(r);return s!==void 0&&(s.forEach(o=>this.overlays=this.overlays.remove(o)),this.qr.delete(r)),S.resolve()}getOverlaysForCollection(t,e,r){const s=Ce(),o=e.length+1,a=new F(e.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const h=l.getNext().value,d=h.getKey();if(!e.isPrefixOf(d.path))break;d.path.length===o&&h.largestBatchId>r&&s.set(h.getKey(),h)}return S.resolve(s)}getOverlaysForCollectionGroup(t,e,r,s){let o=new ct((d,p)=>d-p);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===e&&d.largestBatchId>r){let p=o.get(d.largestBatchId);p===null&&(p=Ce(),o=o.insert(d.largestBatchId,p)),p.set(d.getKey(),d)}}const l=Ce(),h=o.getIterator();for(;h.hasNext()&&(h.getNext().value.forEach((d,p)=>l.set(d,p)),!(l.size()>=s)););return S.resolve(l)}St(t,e,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.qr.get(s.largestBatchId).delete(r.key);this.qr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new yf(e,r));let o=this.qr.get(e);o===void 0&&(o=X(),this.qr.set(e,o)),this.qr.set(e,o.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cm{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return Yl()?8:Nd(Ql())>0?6:4}()}initialize(t,e){this.ps=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,r,s){const o={result:null};return this.ys(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.ws(t,e,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new am;return this.Ss(t,e,a).next(l=>{if(o.result=l,this.Vs)return this.bs(t,e,a,l.size)})}).next(()=>o.result)}bs(t,e,r,s){return r.documentReadCount<this.fs?($e()<=Z.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",He(e),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),S.resolve()):($e()<=Z.DEBUG&&x("QueryEngine","Query:",He(e),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?($e()<=Z.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",He(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,jt(e))):S.resolve())}ys(t,e){if(_a(e))return S.resolve(null);let r=jt(e);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(e.limit!==null&&s===1&&(e=Xs(e,null,"F"),r=jt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=X(...o);return this.ps.getDocuments(t,a).next(l=>this.indexManager.getMinOffset(t,r).next(h=>{const d=this.Ds(e,l);return this.Cs(e,d,a,h.readTime)?this.ys(t,Xs(e,null,"F")):this.vs(t,d,e,h)}))})))}ws(t,e,r,s){return _a(e)||s.isEqual(z.min())?S.resolve(null):this.ps.getDocuments(t,r).next(o=>{const a=this.Ds(e,o);return this.Cs(e,a,r,s)?S.resolve(null):($e()<=Z.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),He(e)),this.vs(t,a,e,Cd(s,jn)).next(l=>l))})}Ds(t,e){let r=new yt(Fc(t));return e.forEach((s,o)=>{Yr(t,o)&&(r=r.add(o))}),r}Cs(t,e,r,s){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Ss(t,e,r){return $e()<=Z.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",He(e)),this.ps.getDocumentsMatchingQuery(t,e,pe.min(),r)}vs(t,e,r,s){return this.ps.getDocumentsMatchingQuery(t,r,s).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xa="ConnectivityMonitor";class Na{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(t){this.qo.push(t)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){x(xa,"Network connectivity changed: AVAILABLE");for(const t of this.qo)t(0)}ko(){x(xa,"Network connectivity changed: UNAVAILABLE");for(const t of this.qo)t(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="WebChannelConnection";class Im extends Tm{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,r,s,o){const a=ni();return new Promise((l,h)=>{const d=new dc;d.setWithCredentials(!0),d.listenOnce(fc.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Ir.NO_ERROR:const y=d.getResponseJson();x(Rt,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(y)),l(y);break;case Ir.TIMEOUT:x(Rt,`RPC '${t}' ${a} timed out`),h(new M(C.DEADLINE_EXCEEDED,"Request time out"));break;case Ir.HTTP_ERROR:const A=d.getStatus();if(x(Rt,`RPC '${t}' ${a} failed with status:`,A,"response text:",d.getResponseText()),A>0){let R=d.getResponseJson();Array.isArray(R)&&(R=R[0]);const N=R==null?void 0:R.error;if(N&&N.status&&N.message){const k=function(B){const U=B.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(U)>=0?U:C.UNKNOWN}(N.status);h(new M(k,N.message))}else h(new M(C.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new M(C.UNAVAILABLE,"Connection failed."));break;default:q(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{x(Rt,`RPC '${t}' ${a} completed.`)}});const p=JSON.stringify(s);x(Rt,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",p,r,15)})}T_(t,e,r){const s=ni(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=gc(),l=pc(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const p=o.join("");x(Rt,`Creating RPC '${t}' stream ${s}: ${p}`,h);const y=a.createWebChannel(p,h);this.I_(y);let A=!1,R=!1;const N=new wm({Yo:V=>{R?x(Rt,`Not sending because RPC '${t}' stream ${s} is closed:`,V):(A||(x(Rt,`Opening RPC '${t}' stream ${s} transport.`),y.open(),A=!0),x(Rt,`RPC '${t}' stream ${s} sending:`,V),y.send(V))},Zo:()=>y.close()}),k=(V,B,U)=>{V.listen(B,H=>{try{U(H)}catch(et){setTimeout(()=>{throw et},0)}})};return k(y,Vn.EventType.OPEN,()=>{R||(x(Rt,`RPC '${t}' stream ${s} transport opened.`),N.o_())}),k(y,Vn.EventType.CLOSE,()=>{R||(R=!0,x(Rt,`RPC '${t}' stream ${s} transport closed`),N.a_(),this.E_(y))}),k(y,Vn.EventType.ERROR,V=>{R||(R=!0,Ze(Rt,`RPC '${t}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),N.a_(new M(C.UNAVAILABLE,"The operation could not be completed")))}),k(y,Vn.EventType.MESSAGE,V=>{var B;if(!R){const U=V.data[0];nt(!!U,16349);const H=U,et=(H==null?void 0:H.error)||((B=H[0])==null?void 0:B.error);if(et){x(Rt,`RPC '${t}' stream ${s} received error:`,et);const ft=et.status;let at=function(_){const T=ht[_];if(T!==void 0)return Qc(T)}(ft),v=et.message;at===void 0&&(at=C.INTERNAL,v="Unknown error status: "+ft+" with message "+et.message),R=!0,N.a_(new M(at,v)),y.close()}else x(Rt,`RPC '${t}' stream ${s} received:`,U),N.u_(U)}}),k(l,mc.STAT_EVENT,V=>{V.stat===$s.PROXY?x(Rt,`RPC '${t}' stream ${s} detected buffering proxy`):V.stat===$s.NOPROXY&&x(Rt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{N.__()},0),N}terminate(){this.c_.forEach(t=>t.close()),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter(e=>e===t)}}function Os(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ka="PersistentStream";class lu{constructor(t,e,r,s,o,a,l,h){this.Mi=t,this.S_=r,this.b_=s,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=l,this.listener=h,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new uu(t,e)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,()=>this.k_()))}q_(t){this.Q_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,e){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():e&&e.code===C.RESOURCE_EXHAUSTED?(te(e.toString()),te("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):e&&e.code===C.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.r_(e)}K_(){}auth(){this.state=1;const t=this.W_(this.D_),e=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,s])=>{this.D_===e&&this.G_(r,s)},r=>{t(()=>{const s=new M(C.UNKNOWN,"Fetching auth token failed: "+r.message);return this.z_(s)})})}G_(t,e){const r=this.W_(this.D_);this.stream=this.j_(t,e),this.stream.Xo(()=>{r(()=>this.listener.Xo())}),this.stream.t_(()=>{r(()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,()=>(this.O_()&&(this.state=3),Promise.resolve())),this.listener.t_()))}),this.stream.r_(s=>{r(()=>this.z_(s))}),this.stream.onMessage(s=>{r(()=>++this.F_==1?this.J_(s):this.onNext(s))})}N_(){this.state=5,this.M_.p_(async()=>{this.state=0,this.start()})}z_(t){return x(ka,`close with error: ${t}`),this.stream=null,this.close(4,t)}W_(t){return e=>{this.Mi.enqueueAndForget(()=>this.D_===t?e():(x(ka,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Am extends lu{constructor(t,e,r,s,o,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}j_(t,e){return this.connection.T_("Listen",t,e)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const e=Vf(this.serializer,t),r=function(o){if(!("targetChange"in o))return z.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?z.min():a.readTime?$t(a.readTime):z.min()}(t);return this.listener.H_(e,r)}Y_(t){const e={};e.database=ti(this.serializer),e.addTarget=function(o,a){let l;const h=a.target;if(l=Qs(h)?{documents:Nf(o,h)}:{query:kf(o,h).ft},l.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){l.resumeToken=Jc(o,a.resumeToken);const d=Ys(o,a.expectedCount);d!==null&&(l.expectedCount=d)}else if(a.snapshotVersion.compareTo(z.min())>0){l.readTime=Ur(o,a.snapshotVersion.toTimestamp());const d=Ys(o,a.expectedCount);d!==null&&(l.expectedCount=d)}return l}(this.serializer,t);const r=Of(this.serializer,t);r&&(e.labels=r),this.q_(e)}Z_(t){const e={};e.database=ti(this.serializer),e.removeTarget=t,this.q_(e)}}class bm extends lu{constructor(t,e,r,s,o,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(t,e){return this.connection.T_("Write",t,e)}J_(t){return nt(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,nt(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){nt(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const e=xf(t.writeResults,t.commitTime),r=$t(t.commitTime);return this.listener.na(r,e)}ra(){const t={};t.database=ti(this.serializer),this.q_(t)}ea(t){const e={streamToken:this.lastStreamToken,writes:t.map(r=>Df(this.serializer,r))};this.q_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe="RemoteStore";class Pm{constructor(t,e,r,s,o){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo(a=>{r.enqueueAndForget(async()=>{Oe(this)&&(x(xe,"Restarting streams for network reachability change."),await async function(h){const d=$(h);d.Ea.add(4),await Yn(d),d.Ra.set("Unknown"),d.Ea.delete(4),await ns(d)}(this))})}),this.Ra=new Cm(r,s)}}async function ns(n){if(Oe(n))for(const t of n.da)await t(!0)}async function Yn(n){for(const t of n.da)await t(!1)}function hu(n,t){const e=$(n);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),xi(e)?Di(e):hn(e).O_()&&Vi(e,t))}function Pi(n,t){const e=$(n),r=hn(e);e.Ia.delete(t),r.O_()&&du(e,t),e.Ia.size===0&&(r.O_()?r.L_():Oe(e)&&e.Ra.set("Unknown"))}function Vi(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(z.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}hn(n).Y_(t)}function du(n,t){n.Va.Ue(t),hn(n).Z_(t)}function Di(n){n.Va=new If({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),hn(n).start(),n.Ra.ua()}function xi(n){return Oe(n)&&!hn(n).x_()&&n.Ia.size>0}function Oe(n){return $(n).Ea.size===0}function fu(n){n.Va=void 0}async function Vm(n){n.Ra.set("Online")}async function Dm(n){n.Ia.forEach((t,e)=>{Vi(n,t)})}async function xm(n,t){fu(n),xi(n)?(n.Ra.ha(t),Di(n)):n.Ra.set("Unknown")}async function Nm(n,t,e){if(n.Ra.set("Online"),t instanceof Yc&&t.state===2&&t.cause)try{await async function(s,o){const a=o.cause;for(const l of o.targetIds)s.Ia.has(l)&&(await s.remoteSyncer.rejectListen(l,a),s.Ia.delete(l),s.Va.removeTarget(l))}(n,t)}catch(r){x(xe,"Failed to remove targets %s: %s ",t.targetIds.join(","),r),await jr(n,r)}else if(t instanceof Rr?n.Va.Ze(t):t instanceof Xc?n.Va.st(t):n.Va.tt(t),!e.isEqual(z.min()))try{const r=await cu(n.localStore);e.compareTo(r)>=0&&await function(o,a){const l=o.Va.Tt(a);return l.targetChanges.forEach((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.Ia.get(d);p&&o.Ia.set(d,p.withResumeToken(h.resumeToken,a))}}),l.targetMismatches.forEach((h,d)=>{const p=o.Ia.get(h);if(!p)return;o.Ia.set(h,p.withResumeToken(bt.EMPTY_BYTE_STRING,p.snapshotVersion)),du(o,h);const y=new ue(p.target,h,d,p.sequenceNumber);Vi(o,y)}),o.remoteSyncer.applyRemoteEvent(l)}(n,e)}catch(r){x(xe,"Failed to raise snapshot:",r),await jr(n,r)}}async function jr(n,t,e){if(!ln(t))throw t;n.Ea.add(1),await Yn(n),n.Ra.set("Offline"),e||(e=()=>cu(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{x(xe,"Retrying IndexedDB access"),await e(),n.Ea.delete(1),await ns(n)})}function mu(n,t){return t().catch(e=>jr(n,e,t))}async function rs(n){const t=$(n),e=Ee(t);let r=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:mi;for(;km(t);)try{const s=await pm(t.localStore,r);if(s===null){t.Ta.length===0&&e.L_();break}r=s.batchId,Mm(t,s)}catch(s){await jr(t,s)}pu(t)&&gu(t)}function km(n){return Oe(n)&&n.Ta.length<10}function Mm(n,t){n.Ta.push(t);const e=Ee(n);e.O_()&&e.X_&&e.ea(t.mutations)}function pu(n){return Oe(n)&&!Ee(n).x_()&&n.Ta.length>0}function gu(n){Ee(n).start()}async function Om(n){Ee(n).ra()}async function Lm(n){const t=Ee(n);for(const e of n.Ta)t.ea(e.mutations)}async function Fm(n,t,e){const r=n.Ta.shift(),s=wi.from(r,t,e);await mu(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await rs(n)}async function Bm(n,t){t&&Ee(n).X_&&await async function(r,s){if(function(a){return vf(a)&&a!==C.ABORTED}(s.code)){const o=r.Ta.shift();Ee(r).B_(),await mu(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s)),await rs(r)}}(n,t),pu(n)&&gu(n)}async function Ma(n,t){const e=$(n);e.asyncQueue.verifyOperationInProgress(),x(xe,"RemoteStore received new credentials");const r=Oe(e);e.Ea.add(3),await Yn(e),r&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await ns(e)}async function Um(n,t){const e=$(n);t?(e.Ea.delete(2),await ns(e)):t||(e.Ea.add(2),await Yn(e),e.Ra.set("Unknown"))}function hn(n){return n.ma||(n.ma=function(e,r,s){const o=$(e);return o.sa(),new Am(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:Vm.bind(null,n),t_:Dm.bind(null,n),r_:xm.bind(null,n),H_:Nm.bind(null,n)}),n.da.push(async t=>{t?(n.ma.B_(),xi(n)?Di(n):n.Ra.set("Unknown")):(await n.ma.stop(),fu(n))})),n.ma}function Ee(n){return n.fa||(n.fa=function(e,r,s){const o=$(e);return o.sa(),new bm(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:Om.bind(null,n),r_:Bm.bind(null,n),ta:Lm.bind(null,n),na:Fm.bind(null,n)}),n.da.push(async t=>{t?(n.fa.B_(),await rs(n)):(await n.fa.stop(),n.Ta.length>0&&(x(xe,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{static emptySet(t){return new Ye(t.comparator)}constructor(t){this.comparator=t?(e,r)=>t(e,r)||F.comparator(e.key,r.key):(e,r)=>F.comparator(e.key,r.key),this.keyedMap=Dn(),this.sortedSet=new ct(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Ye)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu{constructor(t){this.key=t}}class Tu{constructor(t){this.key=t}}class Hm{constructor(t,e){this.query=t,this.Ya=e,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=X(),this.mutatedKeys=X(),this.eu=Fc(t),this.tu=new Ye(this.eu)}get nu(){return this.Ya}ru(t,e){const r=e?e.iu:new Oa,s=e?e.tu:this.tu;let o=e?e.mutatedKeys:this.mutatedKeys,a=s,l=!1;const h=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(t.inorderTraversal((p,y)=>{const A=s.get(p),R=Yr(this.query,y)?y:null,N=!!A&&this.mutatedKeys.has(A.key),k=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let V=!1;A&&R?A.data.isEqual(R.data)?N!==k&&(r.track({type:3,doc:R}),V=!0):this.su(A,R)||(r.track({type:2,doc:R}),V=!0,(h&&this.eu(R,h)>0||d&&this.eu(R,d)<0)&&(l=!0)):!A&&R?(r.track({type:0,doc:R}),V=!0):A&&!R&&(r.track({type:1,doc:A}),V=!0,(h||d)&&(l=!0)),V&&(R?(a=a.add(R),o=k?o.add(p):o.delete(p)):(a=a.delete(p),o=o.delete(p)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),o=o.delete(p.key),r.track({type:1,doc:p})}return{tu:a,iu:r,Cs:l,mutatedKeys:o}}su(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,r,s){const o=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const a=t.iu.ya();a.sort((p,y)=>function(R,N){const k=V=>{switch(V){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return q(20277,{Rt:V})}};return k(R)-k(N)}(p.type,y.type)||this.eu(p.doc,y.doc)),this.ou(r),s=s??!1;const l=e&&!s?this._u():[],h=this.Xa.size===0&&this.current&&!s?1:0,d=h!==this.Za;return this.Za=h,a.length!==0||d?{snapshot:new sn(this.query,t.tu,o,a,t.mutatedKeys,h===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),au:l}:{au:l}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Oa,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach(e=>this.Ya=this.Ya.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.Ya=this.Ya.delete(e)),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=X(),this.tu.forEach(r=>{this.uu(r.key)&&(this.Xa=this.Xa.add(r.key))});const e=[];return t.forEach(r=>{this.Xa.has(r)||e.push(new Tu(r))}),this.Xa.forEach(r=>{t.has(r)||e.push(new vu(r))}),e}cu(t){this.Ya=t.Qs,this.Xa=X();const e=this.ru(t.documents);return this.applyChanges(e,!0)}lu(){return sn.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Oi="SyncEngine";class Gm{constructor(t,e,r){this.query=t,this.targetId=e,this.view=r}}class Km{constructor(t){this.key=t,this.hu=!1}}class Wm{constructor(t,e,r,s,o,a){this.localStore=t,this.remoteStore=e,this.eventManager=r,this.sharedClientState=s,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new ke(l=>Lc(l),Xr),this.Iu=new Map,this.Eu=new Set,this.du=new ct(F.comparator),this.Au=new Map,this.Ru=new bi,this.Vu={},this.mu=new Map,this.fu=rn.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function Qm(n,t,e=!0){const r=Ru(n);let s;const o=r.Tu.get(t);return o?(r.sharedClientState.addLocalQueryTarget(o.targetId),s=o.view.lu()):s=await wu(r,t,e,!0),s}async function Xm(n,t){const e=Ru(n);await wu(e,t,!0,!1)}async function wu(n,t,e,r){const s=await gm(n.localStore,jt(t)),o=s.targetId,a=n.sharedClientState.addLocalQueryTarget(o,e);let l;return r&&(l=await Ym(n,t,o,a==="current",s.resumeToken)),n.isPrimaryClient&&e&&hu(n.remoteStore,s),l}async function Ym(n,t,e,r,s){n.pu=(y,A,R)=>async function(k,V,B,U){let H=V.view.ru(B);H.Cs&&(H=await Va(k.localStore,V.query,!1).then(({documents:v})=>V.view.ru(v,H)));const et=U&&U.targetChanges.get(V.targetId),ft=U&&U.targetMismatches.get(V.targetId)!=null,at=V.view.applyChanges(H,k.isPrimaryClient,et,ft);return Ua(k,V.targetId,at.au),at.snapshot}(n,y,A,R);const o=await Va(n.localStore,t,!0),a=new Hm(t,o.Qs),l=a.ru(o.documents),h=Xn.createSynthesizedTargetChangeForCurrentChange(e,r&&n.onlineState!=="Offline",s),d=a.applyChanges(l,n.isPrimaryClient,h);Ua(n,e,d.au);const p=new Gm(t,e,a);return n.Tu.set(t,p),n.Iu.has(e)?n.Iu.get(e).push(t):n.Iu.set(e,[t]),d.snapshot}async function Jm(n,t,e){const r=$(n),s=r.Tu.get(t),o=r.Iu.get(s.targetId);if(o.length>1)return r.Iu.set(s.targetId,o.filter(a=>!Xr(a,t))),void r.Tu.delete(t);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await ei(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),e&&Pi(r.remoteStore,s.targetId),si(r,s.targetId)}).catch(un)):(si(r,s.targetId),await ei(r.localStore,s.targetId,!0))}async function Zm(n,t){const e=$(n),r=e.Tu.get(t),s=e.Iu.get(r.targetId);e.isPrimaryClient&&s.length===1&&(e.sharedClientState.removeLocalQueryTarget(r.targetId),Pi(e.remoteStore,r.targetId))}async function tp(n,t,e){const r=ap(n);try{const s=await function(a,l){const h=$(a),d=ot.now(),p=l.reduce((R,N)=>R.add(N.key),X());let y,A;return h.persistence.runTransaction("Locally write mutations","readwrite",R=>{let N=ee(),k=X();return h.Ns.getEntries(R,p).next(V=>{N=V,N.forEach((B,U)=>{U.isValidDocument()||(k=k.add(B))})}).next(()=>h.localDocuments.getOverlayedDocuments(R,N)).next(V=>{y=V;const B=[];for(const U of l){const H=pf(U,y.get(U.key).overlayedDocument);H!=null&&B.push(new Me(U.key,H,Vc(H.value.mapValue),zt.exists(!0)))}return h.mutationQueue.addMutationBatch(R,d,B,l)}).next(V=>{A=V;const B=V.applyToLocalDocumentSet(y,k);return h.documentOverlayCache.saveOverlays(R,V.batchId,B)})}).then(()=>({batchId:A.batchId,changes:Uc(y)}))}(r.localStore,t);r.sharedClientState.addPendingMutation(s.batchId),function(a,l,h){let d=a.Vu[a.currentUser.toKey()];d||(d=new ct(Q)),d=d.insert(l,h),a.Vu[a.currentUser.toKey()]=d}(r,s.batchId,e),await Jn(r,s.changes),await rs(r.remoteStore)}catch(s){const o=ki(s,"Failed to persist write");e.reject(o)}}async function Iu(n,t){const e=$(n);try{const r=await fm(e.localStore,t);t.targetChanges.forEach((s,o)=>{const a=e.Au.get(o);a&&(nt(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.hu=!0:s.modifiedDocuments.size>0?nt(a.hu,14607):s.removedDocuments.size>0&&(nt(a.hu,42227),a.hu=!1))}),await Jn(e,r,t)}catch(r){await un(r)}}function Ba(n,t,e){const r=$(n);if(r.isPrimaryClient&&e===0||!r.isPrimaryClient&&e===1){const s=[];r.Tu.forEach((o,a)=>{const l=a.view.va(t);l.snapshot&&s.push(l.snapshot)}),function(a,l){const h=$(a);h.onlineState=l;let d=!1;h.queries.forEach((p,y)=>{for(const A of y.Sa)A.va(l)&&(d=!0)}),d&&Mi(h)}(r.eventManager,t),s.length&&r.Pu.H_(s),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function ep(n,t,e){const r=$(n);r.sharedClientState.updateQueryState(t,"rejected",e);const s=r.Au.get(t),o=s&&s.key;if(o){let a=new ct(F.comparator);a=a.insert(o,Pt.newNoDocument(o,z.min()));const l=X().add(o),h=new ts(z.min(),new Map,new ct(Q),a,l);await Iu(r,h),r.du=r.du.remove(o),r.Au.delete(t),Li(r)}else await ei(r.localStore,t,!1).then(()=>si(r,t,e)).catch(un)}async function np(n,t){const e=$(n),r=t.batch.batchId;try{const s=await dm(e.localStore,t);bu(e,r,null),Au(e,r),e.sharedClientState.updateMutationState(r,"acknowledged"),await Jn(e,s)}catch(s){await un(s)}}async function rp(n,t,e){const r=$(n);try{const s=await function(a,l){const h=$(a);return h.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let p;return h.mutationQueue.lookupMutationBatch(d,l).next(y=>(nt(y!==null,37113),p=y.keys(),h.mutationQueue.removeMutationBatch(d,y))).next(()=>h.mutationQueue.performConsistencyCheck(d)).next(()=>h.documentOverlayCache.removeOverlaysForBatchId(d,p,l)).next(()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p)).next(()=>h.localDocuments.getDocuments(d,p))})}(r.localStore,t);bu(r,t,e),Au(r,t),r.sharedClientState.updateMutationState(t,"rejected",e),await Jn(r,s)}catch(s){await un(s)}}function Au(n,t){(n.mu.get(t)||[]).forEach(e=>{e.resolve()}),n.mu.delete(t)}function bu(n,t,e){const r=$(n);let s=r.Vu[r.currentUser.toKey()];if(s){const o=s.get(t);o&&(e?o.reject(e):o.resolve(),s=s.remove(t)),r.Vu[r.currentUser.toKey()]=s}}function si(n,t,e=null){n.sharedClientState.removeLocalQueryTarget(t);for(const r of n.Iu.get(t))n.Tu.delete(r),e&&n.Pu.yu(r,e);n.Iu.delete(t),n.isPrimaryClient&&n.Ru.jr(t).forEach(r=>{n.Ru.containsKey(r)||Su(n,r)})}function Su(n,t){n.Eu.delete(t.path.canonicalString());const e=n.du.get(t);e!==null&&(Pi(n.remoteStore,e),n.du=n.du.remove(t),n.Au.delete(e),Li(n))}function Ua(n,t,e){for(const r of e)r instanceof vu?(n.Ru.addReference(r.key,t),sp(n,r)):r instanceof Tu?(x(Oi,"Document no longer in limbo: "+r.key),n.Ru.removeReference(r.key,t),n.Ru.containsKey(r.key)||Su(n,r.key)):q(19791,{wu:r})}function sp(n,t){const e=t.key,r=e.path.canonicalString();n.du.get(e)||n.Eu.has(r)||(x(Oi,"New document in limbo: "+e),n.Eu.add(r),Li(n))}function Li(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const t=n.Eu.values().next().value;n.Eu.delete(t);const e=new F(it.fromString(t)),r=n.fu.next();n.Au.set(r,new Km(e)),n.du=n.du.insert(e,r),hu(n.remoteStore,new ue(jt(Ei(e.path)),r,"TargetPurposeLimboResolution",Gr.ce))}}async function Jn(n,t,e){const r=$(n),s=[],o=[],a=[];r.Tu.isEmpty()||(r.Tu.forEach((l,h)=>{a.push(r.pu(h,t,e).then(d=>{var p;if((d||e)&&r.isPrimaryClient){const y=d?!d.fromCache:(p=e==null?void 0:e.targetChanges.get(h.targetId))==null?void 0:p.current;r.sharedClientState.updateQueryState(h.targetId,y?"current":"not-current")}if(d){s.push(d);const y=Ri.As(h.targetId,d);o.push(y)}}))}),await Promise.all(a),r.Pu.H_(s),await async function(h,d){const p=$(h);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",y=>S.forEach(d,A=>S.forEach(A.Es,R=>p.persistence.referenceDelegate.addReference(y,A.targetId,R)).next(()=>S.forEach(A.ds,R=>p.persistence.referenceDelegate.removeReference(y,A.targetId,R)))))}catch(y){if(!ln(y))throw y;x(Ci,"Failed to update sequence numbers: "+y)}for(const y of d){const A=y.targetId;if(!y.fromCache){const R=p.Ms.get(A),N=R.snapshotVersion,k=R.withLastLimboFreeSnapshotVersion(N);p.Ms=p.Ms.insert(A,k)}}}(r.localStore,o))}async function ip(n,t){const e=$(n);if(!e.currentUser.isEqual(t)){x(Oi,"User change. New user:",t.toKey());const r=await au(e.localStore,t);e.currentUser=t,function(o,a){o.mu.forEach(l=>{l.forEach(h=>{h.reject(new M(C.CANCELLED,a))})}),o.mu.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,r.removedBatchIds,r.addedBatchIds),await Jn(e,r.Ls)}}function op(n,t){const e=$(n),r=e.Au.get(t);if(r&&r.hu)return X().add(r.key);{let s=X();const o=e.Iu.get(t);if(!o)return s;for(const a of o){const l=e.Tu.get(a);s=s.unionWith(l.view.nu)}return s}}function Ru(n){const t=$(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=Iu.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=op.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=ep.bind(null,t),t.Pu.H_=zm.bind(null,t.eventManager),t.Pu.yu=$m.bind(null,t.eventManager),t}function ap(n){const t=$(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=np.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=rp.bind(null,t),t}class zr{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=es(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,e){return null}Mu(t,e){return null}vu(t){return hm(this.persistence,new cm,t.initialUser,this.serializer)}Cu(t){return new ou(Si.mi,this.serializer)}Du(t){return new ym}async terminate(){var t,e;(t=this.gcScheduler)==null||t.stop(),(e=this.indexBackfillerScheduler)==null||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}zr.provider={build:()=>new zr};class cp extends zr{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,e){nt(this.persistence.referenceDelegate instanceof qr,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new Kf(r,t.asyncQueue,e)}Cu(t){const e=this.cacheSizeBytes!==void 0?Nt.withCacheSize(this.cacheSizeBytes):Nt.DEFAULT;return new ou(r=>qr.mi(r,e),this.serializer)}}class ii{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Ba(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=ip.bind(null,this.syncEngine),await Um(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new jm}()}createDatastore(t){const e=es(t.databaseInfo.databaseId),r=function(o){return new Im(o)}(t.databaseInfo);return function(o,a,l,h){return new Rm(o,a,l,h)}(t.authCredentials,t.appCheckCredentials,r,e)}createRemoteStore(t){return function(r,s,o,a,l){return new Pm(r,s,o,a,l)}(this.localStore,this.datastore,t.asyncQueue,e=>Ba(this.syncEngine,e,0),function(){return Na.v()?new Na:new Em}())}createSyncEngine(t,e){return function(s,o,a,l,h,d,p){const y=new Wm(s,o,a,l,h,d);return p&&(y.gu=!0),y}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(s){const o=$(s);x(xe,"RemoteStore shutting down."),o.Ea.add(5),await Yn(o),o.Aa.shutdown(),o.Ra.set("Unknown")}(this.remoteStore),(t=this.datastore)==null||t.terminate(),(e=this.eventManager)==null||e.terminate()}}ii.provider={build:()=>new ii};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cu{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):te("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ha="AsyncQueue";class Ga{constructor(t=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new uu(this,"async_queue_retry"),this._c=()=>{const r=Os();r&&x(Ha,"Visibility state changed to "+r.visibilityState),this.M_.w_()},this.ac=t;const e=Os();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.uc(),this.cc(t)}enterRestrictedMode(t){if(!this.ec){this.ec=!0,this.sc=t||!1;const e=Os();e&&typeof e.removeEventListener=="function"&&e.removeEventListener("visibilitychange",this._c)}}enqueue(t){if(this.uc(),this.ec)return new Promise(()=>{});const e=new fe;return this.cc(()=>this.ec&&this.sc?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.Xu.push(t),this.lc()))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(t){if(!ln(t))throw t;x(Ha,"Operation failed with retryable error: "+t)}this.Xu.length>0&&this.M_.p_(()=>this.lc())}}cc(t){const e=this.ac.then(()=>(this.rc=!0,t().catch(r=>{throw this.nc=r,this.rc=!1,te("INTERNAL UNHANDLED ERROR: ",Ka(r)),r}).then(r=>(this.rc=!1,r))));return this.ac=e,e}enqueueAfterDelay(t,e,r){this.uc(),this.oc.indexOf(t)>-1&&(e=0);const s=Ni.createAndSchedule(this,t,e,r,o=>this.hc(o));return this.tc.push(s),s}uc(){this.nc&&q(47125,{Pc:Ka(this.nc)})}verifyOperationInProgress(){}async Tc(){let t;do t=this.ac,await t;while(t!==this.ac)}Ic(t){for(const e of this.tc)if(e.timerId===t)return!0;return!1}Ec(t){return this.Tc().then(()=>{this.tc.sort((e,r)=>e.targetTimeMs-r.targetTimeMs);for(const e of this.tc)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.Tc()})}dc(t){this.oc.push(t)}hc(t){const e=this.tc.indexOf(t);this.tc.splice(e,1)}}function Ka(n){let t=n.message||"";return n.stack&&(t=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wa(n){return function(e,r){if(typeof e!="object"||e===null)return!1;const s=e;for(const o of r)if(o in s&&typeof s[o]=="function")return!0;return!1}(n,["next","error","complete"])}class on extends ss{constructor(t,e,r,s){super(t,e,r,s),this.type="firestore",this._queue=new Ga,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Ga(t),this._firestoreClient=void 0,await t}}}function mp(n,t){const e=typeof n=="object"?n:sd(),r=typeof n=="string"?n:kr,s=Zh(e,"firestore").getImmediate({identifier:r});if(!s._initialized){const o=jl("firestore");o&&fp(s,...o)}return s}function Bi(n){if(n._terminated)throw new M(C.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||pp(n),n._firestoreClient}function pp(n){var r,s,o;const t=n._freezeSettings(),e=function(l,h,d,p){return new Fd(l,h,d,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,Vu(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)}(n._databaseId,((r=n._app)==null?void 0:r.options.appId)||"",n._persistenceKey,t);n._componentsProvider||(s=t.localCache)!=null&&s._offlineComponentProvider&&((o=t.localCache)!=null&&o._onlineComponentProvider)&&(n._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),n._firestoreClient=new up(n._authCredentials,n._appCheckCredentials,n._queue,e,n._componentsProvider&&function(l){const h=l==null?void 0:l._online.build();return{_offline:l==null?void 0:l._offline.build(h),_online:h}}(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uu{constructor(t,e,r,s,o){this._firestore=t,this._userDataWriter=e,this._key=r,this._document=s,this._converter=o}get id(){return this._key.path.lastSegment()}get ref(){return new _t(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new Ap(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const e=this._document.data.field(qu("DocumentSnapshot.get",t));if(e!==null)return this._userDataWriter.convertValue(e)}}}class Ap extends Uu{data(){return super.data()}}function qu(n,t){return typeof t=="string"?Bu(n,t):t instanceof Ui?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Sp(n,t,e){let r;return r=n?n.toFirestore(t):t,r}class Nn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Pe extends Uu{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Cr(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(qu("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new M(C.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t=this._document,e={};return e.type=Pe._jsonSchemaVersion,e.bundle="",e.bundleSource="DocumentSnapshot",e.bundleName=this._key.toString(),!t||!t.isValidDocument()||!t.isFoundDocument()?e:(this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields,"previous"),e.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),e)}}Pe._jsonSchemaVersion="firestore/documentSnapshot/1.0",Pe._jsonSchema={type:dt("string",Pe._jsonSchemaVersion),bundleSource:dt("string","DocumentSnapshot"),bundleName:dt("string"),bundle:dt("string")};class Cr extends Pe{data(t={}){return super.data(t)}}class Ve{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new Nn(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new Cr(this._firestore,this._userDataWriter,r.key,r,new Nn(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new M(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(l=>{const h=new Cr(s._firestore,s._userDataWriter,l.doc.key,l.doc,new Nn(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);return l.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(l=>o||l.type!==3).map(l=>{const h=new Cr(s._firestore,s._userDataWriter,l.doc.key,l.doc,new Nn(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,p=-1;return l.type!==0&&(d=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:Rp(l.type),doc:h,oldIndex:d,newIndex:p}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new M(C.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t={};t.type=Ve._jsonSchemaVersion,t.bundleSource="QuerySnapshot",t.bundleName=di.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const e=[],r=[],s=[];return this.docs.forEach(o=>{o._document!==null&&(e.push(o._document),r.push(this._userDataWriter.convertObjectMap(o._document.data.value.mapValue.fields,"previous")),s.push(o.ref.path))}),t.bundle=(this._firestore,this.query._query,t.bundleName,"NOT SUPPORTED"),t}}function Rp(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return q(61501,{type:n})}}Ve._jsonSchemaVersion="firestore/querySnapshot/1.0",Ve._jsonSchema={type:dt("string",Ve._jsonSchemaVersion),bundleSource:dt("string","QuerySnapshot"),bundleName:dt("string"),bundle:dt("string")};class ji extends bp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ot(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new _t(this.firestore,null,e)}}function Cp(n){n=Jt(n,Zn);const t=Jt(n.firestore,on),e=Bi(t),r=new ji(t);return ju(n._query),dp(e,n._query).then(s=>new Ve(t,r,n,s))}function zu(n,t,e){n=Jt(n,_t);const r=Jt(n.firestore,on),s=Sp(n.converter,t);return $u(r,[vp(Ep(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,zt.none())])}function Pp(n){return $u(Jt(n.firestore,on),[new Ti(n._key,zt.none())])}function Vp(n,...t){var h,d,p;n=Je(n);let e={includeMetadataChanges:!1,source:"default"},r=0;typeof t[r]!="object"||Wa(t[r])||(e=t[r++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Wa(t[r])){const y=t[r];t[r]=(h=y.next)==null?void 0:h.bind(y),t[r+1]=(d=y.error)==null?void 0:d.bind(y),t[r+2]=(p=y.complete)==null?void 0:p.bind(y)}let o,a,l;if(n instanceof _t)a=Jt(n.firestore,on),l=Ei(n._key.path),o={next:y=>{t[r]&&t[r](Dp(a,n,y))},error:t[r+1],complete:t[r+2]};else{const y=Jt(n,Zn);a=Jt(y.firestore,on),l=y._query;const A=new ji(a);o={next:R=>{t[r]&&t[r](new Ve(a,A,y,R))},error:t[r+1],complete:t[r+2]},ju(n._query)}return function(A,R,N,k){const V=new Cu(k),B=new Eu(R,V,N);return A.asyncQueue.enqueueAndForget(async()=>_u(await oi(A),B)),()=>{V.Nu(),A.asyncQueue.enqueueAndForget(async()=>yu(await oi(A),B))}}(Bi(a),l,s,o)}function $u(n,t){return function(r,s){const o=new fe;return r.asyncQueue.enqueueAndForget(async()=>tp(await hp(r),s,o)),o.promise}(Bi(n),t)}function Dp(n,t,e){const r=e.docs.get(t._key),s=new ji(n);return new Pe(n,s,t._key,r,new Nn(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){(function(s){cn=s})(rd),xr(new Un("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new on(new Ed(r.getProvider("auth-internal")),new wd(a,r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new M(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new $n(d.options.projectId,p)}(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),Xe(Zo,ta,t),Xe(Zo,ta,"esm2020")})();const xp={apiKey:"AIzaSyAy96lQqZuRueG_ZeABFzDJwqYuZZA4Fgw",authDomain:"the-spraywall-cellar.firebaseapp.com",projectId:"the-spraywall-cellar",storageBucket:"the-spraywall-cellar.firebasestorage.app",messagingSenderId:"491245667170",appId:"1:491245667170:web:5da5f8bcfc245c09b2a23b"},Np=cc(xp),tr=mp(Np),kp="1.0.0",er="boulders";async function Mp(n){try{await zu(Fi(tr,er,n.id),n)}catch(t){throw console.error("Failed to save boulder to Firebase:",t),new Error("Failed to save boulder. Check your connection.")}}async function Op(n){try{const t=n.map(e=>zu(Fi(tr,er,e.id),e));await Promise.all(t)}catch(t){throw console.error("Failed to save boulders to Firebase:",t),new Error("Failed to save boulders. Check your connection.")}}async function Lp(){try{const n=await Cp(xu(tr,er)),t=[];return n.forEach(e=>{t.push(e.data())}),t}catch(n){return console.error("Failed to load boulders from Firebase:",n),[]}}function Fp(n){return Vp(xu(tr,er),e=>{const r=[];e.forEach(s=>{r.push(s.data())}),n(r)},e=>{console.error("Error subscribing to boulders:",e)})}async function Bp(n){try{await Pp(Fi(tr,er,n))}catch(t){throw console.error("Failed to delete boulder from Firebase:",t),new Error("Failed to delete boulder. Check your connection.")}}function Up(n){const t={version:kp,exportedAt:Date.now(),boulders:n},e=JSON.stringify(t,null,2),r=new Blob([e],{type:"application/json"}),s=URL.createObjectURL(r),o=document.createElement("a");o.href=s,o.download=`spraywall-boulders-${new Date().toISOString().split("T")[0]}.json`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(s)}function qp(n){return new Promise((t,e)=>{const r=new FileReader;r.onload=s=>{var o;try{const a=JSON.parse((o=s.target)==null?void 0:o.result);if(!a.boulders||!Array.isArray(a.boulders))throw new Error("Invalid import file format");t(a.boulders)}catch{e(new Error("Failed to parse import file"))}},r.onerror=()=>{e(new Error("Failed to read file"))},r.readAsText(n)})}const jp="59a6cabc8b017562ccb1f3c9514870b4a677fda5b79788abae3dcea83430cb50";let W={boulders:[],currentBoulder:null,selectedBoulderId:null,mode:"set"},We=null;function Hu(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}async function zp(n){const t=new TextEncoder().encode(n),e=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(e)).map(s=>s.toString(16).padStart(2,"0")).join("")}async function $p(n){return await zp(n)===jp}function Hp(n){return new Promise(t=>{const e=document.createElement("div");e.style.cssText=`
  ...
  `}function Wp(){const n=document.querySelector("#panzoom-container"),t=document.querySelector("#spraywall-img");if(!n||!t)return;const e=()=>{const r=n.parentElement,s=r.clientWidth,o=r.clientHeight,a=t.naturalWidth,l=t.naturalHeight,h=s/a,d=o/l,p=Math.min(h,d),A=Math.max(h,d)*3;We=tc(n,{maxScale:5,minScale:p*.9,cursor:"grab",canvas:!0,step:.1}),We.zoom(A,{animate:!1}),We.pan(0,0,{animate:!1}),r.addEventListener("wheel",R=>{We&&We.zoomWithWheel(R,{step:.1})})};t.complete?e():t.addEventListener("load",e)}function Qa(){return We}function Le(){var s;const n=document.querySelector("#holds-overlay");if(!n)return;n.innerHTML="";const t=((s=W.currentBoulder)==null?void 0:s.holds)||[],e=W.boulders.find(o=>o.id===W.selectedBoulderId);((e==null?void 0:e.holds)||t).forEach(o=>{const a=document.createElement("div");a.className=`hold-marker ${o.type}`,a.style.left=`${o.x}%`,a.style.top=`${o.y}%`,a.dataset.holdId=o.id,a.addEventListener("contextmenu",l=>{l.preventDefault(),Gu(o.id)}),n.appendChild(a)})}function Qp(n,t,e=2){if(!W.currentBoulder)return null;for(const r of W.currentBoulder.holds){const s=Math.abs(r.x-n),o=Math.abs(r.y-t);if(Math.sqrt(s*s+o*o)<e)return r}return null}function Xp(n,t){const e=document.querySelector("#spraywall-img");if(!e)return;const r=e.getBoundingClientRect(),s=(n.clientX-r.left)/r.width*100,o=(n.clientY-r.top)/r.height*100,a=Qp(s,o,1);if(a){Gu(a.id);return}if(!W.currentBoulder){const d=document.querySelector("#boulder-name").value.trim()||"";W.currentBoulder=Gp(d)}const l={id:Hu(),x:Math.max(0,Math.min(100,s)),y:Math.max(0,Math.min(100,o)),type:t};W.currentBoulder.holds.push(l),Le()}function Gu(n){W.currentBoulder&&(W.currentBoulder.holds=W.currentBoulder.holds.filter(t=>t.id!==n),Le())}function Ku(){const n=document.querySelector("#mode-set"),t=document.querySelector("#mode-climb"),e=document.querySelector("#set-mode-content"),r=document.querySelector("#climb-mode-content");!n||!t||!e||!r||(W.mode==="set"?(n.className="flex-1 px-3 py-2 rounded font-medium transition-colors bg-purple-600 text-white",t.className="flex-1 px-3 py-2 rounded font-medium transition-colors text-gray-300 hover:text-white",e.style.display="block",r.style.display="none"):(n.className="flex-1 px-3 py-2 rounded font-medium transition-colors text-gray-300 hover:text-white",t.className="flex-1 px-3 py-2 rounded font-medium transition-colors bg-purple-600 text-white",e.style.display="none",r.style.display="block"))}function Xa(n){W.mode=n,Ku()}async function Yp(){if(!W.currentBoulder){alert("No boulder to save. Add some holds first!");return}if(W.currentBoulder.holds.length===0){alert("Add at least one hold before saving.");return}const n=document.querySelector("#boulder-name"),t=document.querySelector("#boulder-grade"),e=document.querySelector("#boulder-description"),r=n.value.trim();if(!r){alert("Please enter a boulder name."),n.focus();return}const s=t.value.trim();if(!s){alert("Please enter a grade."),t.focus();return}const o=e.value.trim();W.currentBoulder.name=r,W.currentBoulder.grade=s,o?W.currentBoulder.description=o:delete W.currentBoulder.description,W.currentBoulder.updatedAt=Date.now();try{await Mp(W.currentBoulder),W.currentBoulder=null,n.value="",t.value="",e.value="",Le()}catch(a){alert("Failed to save boulder. Please check your connection and try again."),console.error(a)}}function Jp(){W.currentBoulder=null,W.selectedBoulderId=null;const n=document.querySelector("#boulder-name"),t=document.querySelector("#boulder-grade");n&&(n.value=""),t&&(t.value=""),Le(),Hr()}function Hr(){const n=document.querySelector("#boulder-list"),t=document.querySelector("#boulder-count");if(n){if(t&&(t.textContent=W.boulders.length.toString()),W.boulders.length===0){n.innerHTML='<p class="text-gray-500 text-sm">No boulders saved yet.</p>';return}n.innerHTML=W.boulders.sort((e,r)=>r.createdAt-e.createdAt).map(e=>`
        <div
          class="p-4 md:p-3 rounded ${W.selectedBoulderId===e.id?"bg-blue-600":"bg-gray-700 hover:bg-gray-600 active:bg-gray-600"} cursor-pointer"
      ...
      `).join(""),n.querySelectorAll("[data-boulder-id]").forEach(e=>{e.addEventListener("click",r=>{if(r.target.closest("[data-delete-boulder]"))return;const o=e.dataset.boulderId;Zp(o)})}),n.querySelectorAll("[data-delete-boulder]").forEach(e=>{e.addEventListener("click",r=>{r.stopPropagation();const s=e.dataset.deleteBoulder;tg(s)})})}}function Zp(n){W.selectedBoulderId===n?W.selectedBoulderId=null:W.selectedBoulderId=n,Hr(),Le()}async function tg(n){const t=await Hp("Enter password to delete this boulder:");if(!t)return;if(!await $p(t)){alert("Incorrect password. Boulder not deleted.");return}if(confirm("Are you sure you want to delete this boulder?"))try{await Bp(n),W.selectedBoulderId===n&&(W.selectedBoulderId=null,Le())}catch(r){alert("Failed to delete boulder. Please check your connection and try again."),console.error(r)}}function eg(){var h,d,p,y,A,R,N,k,V;let n=null,t=0,e=0,r=!1;(h=document.querySelector("#mode-set"))==null||h.addEventListener("click",()=>{Xa("set")}),(d=document.querySelector("#mode-climb"))==null||d.addEventListener("click",()=>{Xa("climb")}),(p=document.querySelector("#btn-start"))==null||p.addEventListener("click",()=>{n=n==="start"?null:"start",s()}),(y=document.querySelector("#btn-feet-only"))==null||y.addEventListener("click",()=>{n=n==="feet-only"?null:"feet-only",s()}),(A=document.querySelector("#btn-middle"))==null||A.addEventListener("click",()=>{n=n==="middle"?null:"middle",s()}),(R=document.querySelector("#btn-top"))==null||R.addEventListener("click",()=>{n=n==="top"?null:"top",s()});function s(){const B=document.querySelector("#btn-start"),U=document.querySelector("#btn-feet-only"),H=document.querySelector("#btn-middle"),et=document.querySelector("#btn-top");[B,U,H,et].forEach(ft=>{ft==null||ft.classList.remove("ring-2","ring-white")}),n==="start"&&(B==null||B.classList.add("ring-2","ring-white")),n==="feet-only"&&(U==null||U.classList.add("ring-2","ring-white")),n==="middle"&&(H==null||H.classList.add("ring-2","ring-white")),n==="top"&&(et==null||et.classList.add("ring-2","ring-white"))}const o=document.querySelector("#panzoom-container");o==null||o.addEventListener("panzoomstart",()=>{const B=Qa();if(B){const U=B.getPan();t=U.x,e=U.y,r=!1}}),o==null||o.addEventListener("panzoomchange",()=>{const B=Qa();if(B){const U=B.getPan();(Math.abs(U.x-t)>2||Math.abs(U.y-e)>2)&&(r=!0)}}),o==null||o.addEventListener("panzoomend",()=>{setTimeout(()=>{r=!1},100)});const a=document.querySelector("#spraywall-img");a==null||a.addEventListener("click",B=>{n&&(r||Xp(B,n))}),(N=document.querySelector("#btn-save"))==null||N.addEventListener("click",Yp),(k=document.querySelector("#btn-clear"))==null||k.addEventListener("click",Jp),(V=document.querySelector("#btn-export"))==null||V.addEventListener("click",()=>{if(W.boulders.length===0){alert("No boulders to export.");return}Up(W.boulders)});const l=document.querySelector("#input-import");l==null||l.addEventListener("change",async B=>{var H;const U=(H=B.target.files)==null?void 0:H[0];if(U){try{const et=await qp(U);confirm(`Import ${et.length} boulders? This will add to your current data.`)&&(await Op(et),alert("Boulders imported successfully!"))}catch(et){alert("Failed to import boulders. Please check the file format."),console.error(et)}l.value=""}})}async function Ya(){Kp(),W.boulders=await Lp(),Hr(),Fp(n=>{W.boulders=n,Hr(),W.selectedBoulderId&&Le()}),Wp(),eg(),Ku()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ya):Ya();
